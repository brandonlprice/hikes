	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "Turn left here to head back. (An option to extend involves going straight. The path eventually veers left and runs into Dover Dr. Turn left there and take the sidewalk back to the parking lot.)"
			}
			},
			{
			"date": "",

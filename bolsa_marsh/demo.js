	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "It is free to park. Although the parking lot is small, there still should be a couple spaces open. If not, something should open within a couple minutes. Start the hike at the bridge in the picture."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Take the bridge to the other side. It usually will have people on it bird watching."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Turn here and go slightly uphill towards the little plateau."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Turn left after you have crossed it."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Turn Right</h6>",
				"text": "Turn right into the opening between the wooden fence boards. You will then be on the first narrow strip you initially entered. Take it back the way you came."
			}
			}
		]
	}

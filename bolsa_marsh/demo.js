	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "This reserve is a state protected marsh/wetlands in north Huntington Beach off Pacific Coast Highway. On the other side of the highway is Bolsa Chica State Beach."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>The Rundown:</h6> <small style='color:red;'><ul><li>2.8 miles (Out & Back)</li><li>Intermittent Steep Sections, No Shade</li><li>Check for Alerts</li><li>Parking</li></ul></small>",

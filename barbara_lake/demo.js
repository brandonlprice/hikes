	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "This is one of the three natural occuring lakes in Orange County which are all located within a quarter-mile from each other in Laguna Canyon. This is the only one that does not dry out and cannot be seen from Laguna Canyon Road."
			}
			},
			{
			"date": "",
			...
			"location": { 
				"lat":  33.59885987314894,  
				"line": false,
				"lon": -117.74777804647768,
				"zoom": 19
			},
			"text": {
				"headline": "<h6 style='color:red;'>The Rundown:</h6> <small style='color:red;'><ul><li>2.13 miles</li><li>Intermittent Steep Sections, No Shade</li><li>Partial Loop</li><li><u>Trail Status</u></li><li>Park at the <font size=4><a href='https://maps.app.goo.gl/ijumYUUbs33kkBWN6' target='_blank'>El Toro Bl/Aliso Creek Rd Intersection</a> or <a href='https://maps.app.goo.gl/yXop7Y6PJQZTLonJ9' target='_blank'>Hummingbird Park</a></font></li></ul></small>",
				"text": "This route offers free street parking. Three spots are available on El Toro Bl at the Aliso Creek Rd intersection. Additional street parking is at Hummingbird Park."
			}
			},
			{
			"date": "",
			"media": {
				"url": "images/IMG_1092_11zon.jpg",
				"caption": "Hummingbird Park Street Parking",
				"credit": ""
			},
			"location": { 
				"lat":  33.59766693718836,  
				"line": false,
				"lon": -117.74585878300559,
				"zoom": 19
			},
			"text": {
			...
			"text": {
				"headline": "<h6 style='color:red;'>Stay Right</h6>",
				"text": "Stay right here. Multiple dead end offshoot trails to cell towers in this descend. Turn around and resume the correct trail if you make a mistake."
			}
			},
			{
			"date": "",

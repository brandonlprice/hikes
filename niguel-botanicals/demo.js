	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "The incline picks up again here. This takes you to the top of the garden. There are no further inclines after this."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>TPass Benches</h6>",

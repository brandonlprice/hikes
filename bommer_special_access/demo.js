	...
	"storymap": {
		...
		"slides": [
			...
			"media": {
				...
				"caption": "<i>Ridge Route Trail, Bommer Canyon, Irvine, Spring 2022</i>",
				"credit": ""
			},
			"type": "overview",
			"location": {
			...
			"text": {
				"headline": "Bommer Canyon <small>(Special Access)</small><small>Irvine, CA</small>",
				"text": "This is a nice hike that follows the East Fork and Ridge Route trails in Bommer Canyon. It gets little attention because the East Fork trail is only accessible on wilderness access days or via a scheduled hike. Check <a href='https://letsgooutside.org/' target='_blank'><i>letsgooutside.org</i></a> for the next Bommer Canyon wilderness access day or scheduled hike.<ul><b><li>3.4 mile loop</li><li>Steep sections with brief shaded relief</li><li>Duration: 1 ½ hours</li><li>Check for alerts on <a href='https://letsgooutside.org' target='_blank'><i>letsgooutside.org↗</i></a></li></b></ul>"
			}
			},
			{
			"date": "",
			...
			"location": {
				"lat": 33.60568309987628, 
				"line": false,
				"lon": -117.78908668102902,
				"zoom": 19
			},
			"text": {

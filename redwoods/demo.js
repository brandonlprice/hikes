	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "The short trek to the Redwoods in Carbon Canyon Regional Park is flat and generally easy. These trees have been growing here since the late 1970's from seeds that were planted shortly after the park first opened. There a fee of $3 on the weekdays and $5 on the weekends to enter the park."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>The Rundown:</h6> <small style='color:red;'><ul><li>.75 miles</li><li>Short and flat with little shade</li><li>Park Entrance Fee of $3 (weekdays)/$5 (weekends)</li><li><a href='https://www.ocparks.com/parks-trails/carbon-canyon-regional-park' target='_blank'><i>Check for Alerts</i></a></li></ul></small>",

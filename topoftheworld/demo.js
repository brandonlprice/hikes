	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "This trail takes you to one of the most visited scenic destinations in Orange County called \"Top of the World\" in Laguna Beach. At 1,083 feet, it is the highest elevation point next to the ocean in the county. And while not as tall as the peaks on the Malibu Coast, it still is very scenic. There are four main ways to get there: this way which starts in Aliso Viejo, the Canyon Acres Trail in Laguna Beach, another unnamed trail in Laguna Beach, or driving there (most popular)."
			}
			},
			{
			"date": "",

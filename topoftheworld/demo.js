	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "This trail takes you to one of the most visited scenic destinations in Orange County called \"Top of the World\" in Laguna Beach. It's known for being one of the highest elevation points next to the ocean in the county. It is slightly above 1,000 feet, which may not be as tall as the 3,000 foot Santa Monica Mountains on the Malibu Coast, but still has nice views. There are four main ways to get there: this way which starts in Aliso Viejo, the Canyon Acres Trail in Laguna Beach, another unnamed trail in Laguna Beach, or driving there."
			}
			},
			{
			"date": "",

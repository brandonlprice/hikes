	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "This trail takes you to one of the most visited scenic destinations in Orange County called \"Top of the World\" in Laguna Beach. It's known for being one of the highest elevation points next to the ocean in the county. It stands slightly above 1,000 feet. It may not be as tall as the 3,000 foot Santa Monica Mountains on the Malibu Coast, it's still a nice visit. There are four main ways to get there: this way which starts in Aliso Viejo, the Canyon Acres Trail in Laguna Beach, another unnamed trail in Laguna Beach, or driving there."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>The Rundown:</h6> <small style='color:red;'><ul><li>4 miles (Out and Back)</li><li>No shade and intermittent steep sections</li><li><i>Parking</i></li><li><i>Trail Status</i></li></ul></small>",

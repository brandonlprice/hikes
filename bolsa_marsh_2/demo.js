	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "This reserve is a state protected marsh/wetlands in north Huntington Beach off Pacific Coast Highway. On the other side of the highway is Bolsa Chica State Beach. The hike begins on the northside of this reserve which has an interpretive center with live animals."
			}
			},
			{
			"date": "",

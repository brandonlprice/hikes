	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "The Buck Gully trail is in the Newport Coast community of Newport Beach and is managed by the city. The trail is a single-track, but can be hiked in a loop by connecting to other trails like in this example.<ul><font size='5'><b><li>2.8 mile-loop</li><li>Densely shaded sections, minor inclines, stream crossings</li><li>1 hour</li></b></font></ul>"
			}
			},
			{
			"date": "",

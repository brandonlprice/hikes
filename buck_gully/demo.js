	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "The Buck Gully trail is located in the Newport Coast neighborhood of Newport Beach and is managed by the city of Newport Beach. This trail is a single-track, but can also be done in a loop by taking other trails like in this example."
			}
			},
			{
			"date": "",

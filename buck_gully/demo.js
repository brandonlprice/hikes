let demojs={
	"storymap": {
		...
		"slides": [
			...
			"text": {
				"headline": "<h4>Buck Gully Loop</h4>",
			...
			"text": {
				...
				"text": "Start the hike at the sidewalk to the right of the parking lot. This hike loops back to this location after going thru the Gully."
			}
			},
			{
			"date": "",

	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "The trail will begin veer back to the right leaving the residential area towards the ocean. There will be some downhill at this point, but it will be also be brief and then flatten out. It is not as steep as the first steep section. It will be a straight shot to the peak from here."
			}
			},
			{
			"date": "",

	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "The Aliso Peak trail takes you from Seaview Park to Aliso Peak. At a 683-foot elevation, it is one of the closest peaks you can hike to overlooking the ocean in Orange County. The trail is maintained by OC Parks and is part of Aliso & Wood Canyons Wilderness Park. The hike is short although does have one brief steep and rocky section."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>The Rundown:</h6> <small style='color:red;'><ul><li>1.5 miles</li><li>One Moderate Steep Section</li><li>No Shade</li><li>Out & Back</li><li>Parking</li><li>Trail Status</li></ul></small>",
			...
			"text": {
				...
				"text": "A third of the way in, the warmup section will end. A big bush will be in front of you, a picnic table will be on the right, and a summit with overlooking views of the ocean will be on the left. Going left is what most do since people are usually at the picnic table on the right. This photo was taken on the left."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Continue enjoying ocean views on the left side as you go around the bush before starting the next section. After this, ocean views will continue, but you will need to focus more on footing as you go downhill."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "A few yards down into the bushes, views will begin to open up again of the ocean. Continue to be alert and watch your footing. Ocean views are not always present when it is cloudy which is often in this area."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "The trail will veer back to the right leaving the residential area going towards the ocean. There will still be some downhill at this point, but it will be brief and then flatten out. It also will not be as steep as the previous section and it will be a straight shot to the peak from here."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "The peak should now look a lot closer and be directly in front of you. You will descend again briefly, but the trail will also be wider and less steep as before."
			}
			},
			{
			"date": "",

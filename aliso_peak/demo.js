let demojs={
	"storymap": {
		...
		"slides": [
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill</h6>",
				"text": "Another shot going downhill. Taken on a different day. Trail conditions can vary as there were a lot less shrubs when this was taken. It just depends on when the last trail maintenance work was done."
			}
			},
			{
			"date": "",

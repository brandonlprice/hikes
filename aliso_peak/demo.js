let demojs={
	"storymap": {
		...
		"slides": [
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill</h6>",
				"text": "Not even less than a few yards down between these bushes, it will begin to open up again with ocean views. Continue to be alert and watch you're footing here still. Ocean views are not always present when it is cloudy which happens often in this area."
			}
			},
			{
			"date": "",

	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "Once parked, this is where you'll start. It will be on the right side of the street at the end of Talavera Drive once you pass the grassy park/lawn area (which also has equally nice views). Enter the trail and go left towards the ocean."
			}
			},
			{
			"date": "",

	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "A third of a mile in, this part of the trail will come to an end. A big bush will be in front of you, a picnic table will be on the right, and the left will be somewhat like a summit with nice overlooking views of the ocean. Go left or right around the bush to continue. This image was taken on the left side of the bush."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "You can enjoy views on the left side of the bush before starting the next section. There will still be ocean views as you continue, but you will need to focus more on footing in the next section as you go downhill."
			}
			},
			{
			"date": "",

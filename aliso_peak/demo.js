	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "A third of a mile in, this part of the trail will come to an end. A big bush will be in front of you, a picnic table will be on the right, and the left will be a summit with nice overlooking views of the ocean. Go left or right around the bush to continue. This image was taken on the left side of the bush."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "As you go around the bush, you can enjoy views on the left side before starting the next section. The right side will have a picnic table to enjoy the views. Ocean views will continue, but you will need to focus more on footing in the next section as you go downhill."
			}
			},
			{
			"date": "",

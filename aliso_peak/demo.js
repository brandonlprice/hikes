	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "The <b><i>Aliso Peak Trail</i></b> takes you from Seaview Park to Aliso Peak. At 683 feet, it is one of the closest peaks to the ocean in Orange County. The trail is maintained by OC Parks and is part of Aliso & Wood Canyons Wilderness Park."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>The Rundown:</h6> <small style='color:red;'><ul><li>1.6 miles (Out and Back)</li><li>One moderate steep section with mainly no shade</li><li><u>Parking</u></li><li><u>Trail Status</u></li></ul></small>",
			...
			"text": {
				...
				"text": "This trail entrance is at the end of Talavera Drive on the right side once you pass Seaview Park (the lawn area, which also has nice views). Enter here and go left on the Aliso Peak trail towards the ocean."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "This part is flat and wide with multiple picnic tables located on both sides. Other people are normally present on this hike and some bring their dogs to this section."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "The trail breaks left down into a neighborhood with nice houses."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "The peak is now a lot closer and directly in front of you as you descend. The trail is wider and less steep than earlier."
			}
			},
			{
			"date": "",

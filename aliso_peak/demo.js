	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "A third of the way in, the warmup section will end. A big bush will be in front of you, a picnic table will be on the right, and a summit with nice overlooking views of the ocean will be on the left. Going left is what most do since people are usually at the picnic table on the right. This photo was taken on the left."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Continue enjoying ocean views on the left side of as you go around the bush before starting the next section. After this, the ocean views will continue, but you will need to focus more on footing in the next section as you go downhill."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Not even less than a few yards down between these bushes, it will begin to open up again with ocean views. Continue to be alert and watch your footing. Ocean views are not always present when it is cloudy which is often in this area."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "At this point, the trail will veer back to the right leaving the residential area going towards the ocean. There will still be some downhill at this point, but it will be brief and then flatten out. It will not be as steep as the previous section and it will be a straight shot to the peak from here."
			}
			},
			{
			"date": "",

	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "Once parked, the trail starts here. This sign will be on the right side of the street at the end of Talavera Drive once you pass the Seaview Park lawn area (which also has equally nice views). Enter the trail and go left towards the ocean. Going right takes you to the grassy area."
			}
			},
			{
			"date": "",

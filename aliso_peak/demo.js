	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "A third of a mile in, the warmup section will come to an end. A big bush will be in front of you, a picnic table will be on the right, and a summit with nice overlooking views of the ocean will be on the left. Going left is usually what most do since people are usually at the picnic table on the right side of the bush. This photo was taken on the left."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill</h6>",
				"text": "Not even less than a few yards down between these bushes, it will begin to open up again with ocean views. Continue to be alert and watch you're footing here still. Ocean views may not be present when it is cloudy which happens often in this area."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "You will end up in the residential area right next to the sidewalk once you are down the hill the steepest hill. Follow the arrow as seen in the image to continue the hike."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "The trail will begin veer back to the right leaving the residential area towards the ocean. There will be some downhill still at this point, but it will be also be brief and then flatten out. It will not be as steep as the first steep section and will be a straight shot to the peak from here."
			}
			},
			{
			"date": "",

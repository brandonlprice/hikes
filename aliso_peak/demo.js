let demojs={
	"storymap": {
		...
		"slides": [
			...
			"text": {
				"headline": "<h6 style='color:red;'>The Rundown:</h6> <small style='color:red;'><ul><li>1.5 miles (Out and Back)</li><li>One moderate steep section with mainly no shade</li><li>Parking</li><li>Trail Status</li></ul></small>",
			...
			"text": {
				...
				"text": "This beginning of the hike is a nice, flat, and wide trail. Picnic benches can be found on both sides of the trail. Other people will usually be present on this hike. Some may bring their dogs to this section."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "A few yards down, views will open up again of the ocean. Be alert and watch your footing. <i>FYI-Ocean views are not always present when it is cloudy which happens often.</i>"
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill Continued</h6>",
				"text": "Another shot going downhill, taken on a different day. Trail conditions vary depending on when you go. It may be dense with shrubs or shrubs may be removed or trimmed. It depends on if any trail maintenance work was done."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "The trail will veer back to the right leaving the residential area going towards the peak. There will still be some downhill, but it will be brief then flatten out. It also will not be as steep as the previous section."
			}
			},
			{
			"date": "",

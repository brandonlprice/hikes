	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "The <b><i>Aliso Peak Trail</i></b> takes you from Seaview Park to Aliso Peak. At a 683-foot elevation, it is one of the closest peaks to the ocean in Orange County. The trail is maintained by OC Parks and is part of Aliso & Wood Canyons Wilderness Park. The hike is short although has a brief steep and rocky section."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "The trail starts here at this sign at the end of Talavera Drive on the right side once you pass Seaview Park (the lawn area, which also has equally nice views). Enter here and go left on the Aliso Peak trail towards the ocean. Going right takes you to the park lawn."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill Continued</h6>",
				"text": "Another shot going downhill, taken on a different day. Trail conditions vary depending on when trail maintenance work was last done."
			}
			},
			{
			"date": "",

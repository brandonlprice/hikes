	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "Park along the end of Talavera Dr right before it runs into the gated community. The trail starts in Laguna Niguel although ends in Laguna Beach."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Once parked, this is where you'll start. It will be on the right side of the street at the end of Talavera Drive once you pass the grassy park/lawn area (which also has equally nice views). Enter the trail and go left towards the ocean. Going right takes you to the grassy area."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Enjoy the views before starting a descend. There will still be ocean views as you continue, but you will need to focus more on footing as you go downhill. The image taken is on the left side of the bush that you will run into."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill</h6>",
				"text": "Not even less than a few yards down between the bushes it will begin to open up again with ocean views. Continue to be alert and watch you're footing here still. Ocean views may not be present when it is cloudy which happens often in this area."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill</h6>",
				"text": "Another shot going downhill. Taken on different day. Trail conditions can vary as there were a lot less shrubs when this was taken. It just depends on when the last trail maintenance work was done."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill</h6>",
				"text": "You will start to see nice houses as the trail breaks left down the hill."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "The trail will begin veer right going away from the residential area. There will be some slight downhill at this point, but it will be nothing major and eventually fairly flat. It will be a straight shot to the peak from here."
			}
			},
			{
			"date": "",

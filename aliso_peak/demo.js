	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "Once parked, this is where you'll start. This sign will be on the right side of the street at the end of Talavera Drive once you pass the grassy park/lawn area (which also has equally nice views). Enter the trail and go left towards the ocean. Going right takes you to the grassy area."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Enjoy the views before starting the next section. There will still be ocean views as you continue, but you will need to focus more on footing in the next section as you go downhill. This image taken is also on the left side of the bush that you will run into right before the start of the  next section."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill</h6>",
				"text": "Another shot going downhill. Taken on a different day. Trail conditions will vary depending on when you go. This area may be dense with shrubs or the shrubs may not be. It depends on if any trail maintenance work was done."
			}
			},
			{
			"date": "",
			...
			"text": {
				"headline": "<h6 style='color:red;'>Going Downhill</h6>",
				"text": "As the first descend ends, you will start to see nice houses as the trail breaks left down the hill towards the neighborhood."
			}
			},
			{
			"date": "",

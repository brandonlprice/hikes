          ...
          this._miniMap.whenReady(
            L.Util.bind(function () {
              (this._aimingRect = L.rectangle(this._mainMap.getBounds(), this.options.aimingRectOptions).addTo(this._miniMap)),
                ...
                (this._locationCircle = L.circleMarker(this._mainMap.getCenter(), { fillColor: "#641818", color: "#FFFFFF", weight: 2, radius: 10, fill: !0, fillOpacity: 1, stroke: !0, clickable: !1 }).addTo(this._miniMap)),

    ...
    ( () => {
        ...
        class Et {
            ...
            _initOptions() {
                ...
                0 == this.options.map_type.indexOf("stamen")) {
                    const t = this.options.map_type;
                    this.options.map_type = "stamen:watercolor" == t ? "ch-watercolor" : "osm:standard",
                    console.log(`Deprecated map_type ${t}; using ${this.options.map_type}`)
                }

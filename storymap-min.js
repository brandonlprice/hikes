...
(() => {
  ...
  (() => {
          ...
          this._miniMap.whenReady(
            L.Util.bind(function () {
              (this._aimingRect = L.rectangle(this._mainMap.getBounds(), this.options.aimingRectOptions).addTo(this._miniMap)),
                ...
                (this._locationCircle = L.circleMarker(this._mainMap.getCenter(), { fillColor: "#FFD700", color: "#FFFFFF", weight: 2, radius: 10, fill: !0, fillOpacity: 1, stroke: !0, clickable: !1 }).addTo(this._miniMap)),
    ...
    class Et {
      constructor(t, e, i, o) {
        ...
        return (
          ...
          (this.options = {
            ...
            trackResize: !0,
            map_type: "stamen:toner-lite",
            attribution: "Hike Orange County",
            map_mini: !0,
            map_subdomains: "",
            map_as_image: !1,
      ...
      _onOverview(t) {
        window.history.back();//this._map.markerOverview();
      }
      _onBackToStart(t) {

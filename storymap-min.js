...
(() => {
  var t = {
      243: (t, e, i) => {
        ...
        !(function (s, a, r) {
          ...
          (d.version = "0.7.7"),
            ...
            (d.Util = {
              extend: function (t) {
                ...
                for (i = 0, o = s.length; i < o; i++) for (e in (n = s[i] || {})) n.hasOwnProperty(e) && (t[e] = n[e]);
                return t;
              },
              bind: function (t, e) {
            ...
            (d.Class.extend = function (t) {
              ...
              t.statics && (d.extend(e, t.statics), delete t.statics),
                t.includes && (d.Util.extend.apply(null, [o].concat(t.includes)), delete t.includes),
          ...
          (d.Mixin = {}),
            (d.Mixin.Events = {
              addEventListener: function (t, e, i) {
                ...
                for (o = 0, n = (t = d.Util.splitWords(t)).length; o < n; o++)
                  (s = { action: e, context: i || this }), (a = t[o]), p ? ((h = (r = a + "_idx") + "_len"), (l = c[r] = c[r] || {})[p] || ((l[p] = []), (c[h] = (c[h] || 0) + 1)), l[p].push(s)) : ((c[a] = c[a] || []), c[a].push(s));
                return this;
              },
              ...
              fireEvent: function (t, e) {
                ...
                var i,
                  ...
                  s,
                  a,
                  r = d.Util.extend({}, e, { type: t, target: this }),
                  h = this[A];
                if (h[t]) for (o = 0, n = (i = h[t].slice()).length; o < n; o++) i[o].action.call(i[o].context, r);
                for (a in (s = h[t + "_idx"])) if ((i = s[a].slice())) for (o = 0, n = i.length; o < n; o++) i[o].action.call(i[o].context, r);
                return this;
              },
            ...
            (w = -1 !== u.indexOf("gecko")),
            (b = "undefined" != typeof orientation),
            ...
            (d.Bounds.prototype = {
              ...
              contains: function (t) {
                var e, i;
                return (
                  (t = "number" == typeof t[0] || t instanceof d.Point ? d.point(t) : d.bounds(t)) instanceof d.Bounds ? ((e = t.min), (i = t.max)) : (e = i = t),
            ...
            (d.DomUtil = {
              ...
              addClass: function (t, e) {
                if (t.classList !== r) for (var i = d.Util.splitWords(e), o = 0, n = i.length; o < n; o++) t.classList.add(i[o]);
              ...
              testProp: function (t) {
                for (var e = a.documentElement.style, i = 0; i < t.length; i++) if (t[i] in e) return t[i];
                return !1;
              },
            ...
            d.extend(d.LatLng, { DEG_TO_RAD: Math.PI / 180, RAD_TO_DEG: 180 / Math.PI, MAX_MARGIN: 1e-9 }),
            (d.LatLng.prototype = {
              equals: function (t) {
            ...
            (d.latLng = function (t, e) {
              return t instanceof d.LatLng
                ? t
                : d.Util.isArray(t)
                ? "number" == typeof t[0] || "string" == typeof t[0]
                  ? new d.LatLng(t[0], t[1], t[2])
                  : null
                : t === r || null === t
                ? t
                : "object" == typeof t && "lat" in t
                ? new d.LatLng(t.lat, "lng" in t ? t.lng : t.lon)
                : e === r
                ? null
                : new d.LatLng(t, e);
            }),
            ...
            (d.LatLngBounds.prototype = {
              extend: function (t) {
                ...
                var e = d.latLng(t);
                return (
                  (t = null !== e ? e : d.latLngBounds(t)) instanceof d.LatLng
                    ? this._southWest || this._northEast
                      ...
                      : ((this._southWest = new d.LatLng(t.lat, t.lng)), (this._northEast = new d.LatLng(t.lat, t.lng)))
                    : t instanceof d.LatLngBounds && (this.extend(t._southWest), this.extend(t._northEast)),
                  this
                );
              },
              pad: function (t) {
            ...
            (d.CRS.EPSG900913 = d.extend({}, d.CRS.EPSG3857, { code: "EPSG:900913" })),
            (d.CRS.EPSG4326 = d.extend({}, d.CRS, { code: "EPSG:4326", projection: d.Projection.LonLat, transformation: new d.Transformation(1 / 360, 0.5, -1 / 360, 0.5) })),
            (d.Map = d.Class.extend({
              includes: d.Mixin.Events,
              options: { crs: d.CRS.EPSG3857, fadeAnimation: d.DomUtil.TRANSITION && !d.Browser.android23, trackResize: !0, markerZoomAnimation: d.DomUtil.TRANSITION && d.Browser.any3d },
              initialize: function (t, e) {
                (e = d.setOptions(this, e)),
                  ...
                  e.center && e.zoom !== r && this.setView(d.latLng(e.center), e.zoom, { reset: !0 }),
                  (this._handlers = []),
                  (this._layers = {}),
              ...
              addLayer: function (t) {
                ...
                return (
                  this._layers[e] ||
                    ...
                    this.options.zoomAnimation && d.TileLayer && t instanceof d.TileLayer && (this._tileLayersNum++, this._tileLayersToLoad++, t.on("load", this._onTileLayerLoad, this)),
              ...
              removeLayer: function (t) {
                ...
                return this._layers[e]
                  ? (this._loaded && t.onRemove(this),
                    ...
                    this.options.zoomAnimation && d.TileLayer && t instanceof d.TileLayer && (this._tileLayersNum--, this._tileLayersToLoad--, t.off("load", this._onTileLayerLoad, this)),
                    this)
                  : this;
              },
              hasLayer: function (t) {
              ...
              invalidateSize: function (t) {
                ...
                t = d.extend({ animate: !1, pan: !0 }, !0 === t ? { animate: !0 } : t);
                var e = this.getSize();
                ...
                return s.x || s.y
                  ? (t.animate && t.pan
                      ? this.panBy(s)
                      : (t.pan && this._rawPanBy(s), this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), (this._sizeTimer = setTimeout(d.bind(this.fire, this, "moveend"), 200))) : this.fire("moveend")),
              ...
              _initLayout: function () {
                ...
                d.DomUtil.addClass(
                  t,
                  "leaflet-container" + (d.Browser.touch ? " leaflet-touch" : "") + (d.Browser.retina ? " leaflet-retina" : "") + (d.Browser.ielt9 ? " leaflet-oldie" : "") + (this.options.fadeAnimation ? " leaflet-fade-anim" : "")
                );
              ...
              _resetView: function (t, e, i, o) {
                var n = this._zoom !== e;
                o || (this.fire("movestart"), n && this.fire("zoomstart")),
                  (this._zoom = e),
                ...
                var s = !this._loaded;
                (this._loaded = !0), this.fire("viewreset", { hard: !i }), s && (this.fire("load"), this.eachLayer(this._layerAdd, this)), this.fire("move"), (n || o) && this.fire("zoomend"), this.fire("moveend", { hard: !i });
              },
              ...
              _fireMouseEvent: function (t) {
                if (this._loaded && !d.DomEvent._skipped(t)) {
                  ...
                  if (((e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e), this.hasEventListeners(e))) {
                    ...
                    this.fire(e, { latlng: n, layerPoint: o, containerPoint: i, originalEvent: t });
                  }
                }
              },
            ...
            (d.Projection.Mercator = {
              ...
              project: function (t) {
                var e = d.LatLng.DEG_TO_RAD,
                  ...
                  l = Math.sqrt(1 - h * h),
                  c = l * Math.sin(r);
                c = Math.pow((1 - c) / (1 + c), 0.5 * l);
                var p = Math.tan(0.5 * (0.5 * Math.PI - r)) / c;
                return (r = -n * Math.log(p)), new d.Point(a, r);
              },
              unproject: function (t) {
                for (
                  var e, i = d.LatLng.RAD_TO_DEG, o = this.R_MAJOR, n = this.R_MINOR, s = (t.x * i) / o, a = n / o, r = Math.sqrt(1 - a * a), h = Math.exp(-t.y / o), l = Math.PI / 2 - 2 * Math.atan(h), c = 15, p = 0.1;
                  Math.abs(p) > 1e-7 && --c > 0;

                )
                  (e = r * Math.sin(l)), (l += p = Math.PI / 2 - 2 * Math.atan(h * Math.pow((1 - e) / (1 + e), 0.5 * r)) - l);
            ...
            (d.CRS.EPSG3395 = d.extend({}, d.CRS, {
              ...
              transformation: ((O = d.Projection.Mercator.R_MAJOR), (z = 0.5 / (Math.PI * O)), new d.Transformation(z, 0.5, -z, 0.5)),
            })),
            (d.TileLayer = d.Class.extend({
              includes: d.Mixin.Events,
              options: { minZoom: 0, maxZoom: 26, tileSize: 256, subdomains: "abc", errorTileUrl: "", attribution: "", zoomOffset: 0, opacity: 1, unloadInvisibleTiles: d.Browser.mobile, updateWhenIdle: d.Browser.mobile },
              initialize: function (t, e) {
                (e = d.setOptions(this, e)).detectRetina && d.Browser.retina && e.maxZoom > 0 && ((e.tileSize = Math.floor(e.tileSize / 2)), e.zoomOffset++, e.minZoom > 0 && e.minZoom--, this.options.maxZoom--),
              ...
              onAdd: function (t) {
                (this._map = t),
                  ...
                  this.options.updateWhenIdle || ((this._limitedUpdate = d.Util.limitExecByInterval(this._update, 150, this)), t.on("move", this._limitedUpdate, this)),
                  this._reset(),
                  this._update();
              },
              addTo: function (t) {
              ...
              _updateOpacity: function () {
                var t,
                  e = this._tiles;
                if (d.Browser.ielt9) for (t in e) d.DomUtil.setOpacity(e[t], this.options.opacity);
              ...
              _addTilesFromCenterOut: function (t) {
                var e,
                  ...
                  n = [],
                  s = t.getCenter();
                for (e = t.min.y; e <= t.max.y; e++) for (i = t.min.x; i <= t.max.x; i++) (o = new d.Point(i, e)), this._tileShouldBeLoaded(o) && n.push(o);
                var r = n.length;
                if (0 !== r) {
                  n.sort(function (t, e) {
              ...
              _removeTile: function (t) {
                ...
                this.fire("tileunload", { tile: e, url: e.src }),
                  this.options.reuseTiles ? (d.DomUtil.removeClass(e, "leaflet-tile-loaded"), this._unusedTiles.push(e)) : e.parentNode === this._tileContainer && this._tileContainer.removeChild(e),
                  d.Browser.android || ((e.onload = null), (e.src = d.Util.emptyImageUrl)),
              ...
              getTileUrl: function (t) {
                return d.Util.template(this._url, d.extend({ s: this._getSubdomain(t), z: t.z, x: t.x, y: t.y }, this.options));
              },
              ...
              _tileOnLoad: function () {
                var t = this._layer;
                this.src !== d.Util.emptyImageUrl && (d.DomUtil.addClass(this, "leaflet-tile-loaded"), t.fire("tileload", { tile: this, url: this.src })), t._tileLoaded();
              },
            ...
            (d.TileLayer.WMS = d.TileLayer.extend({
              ...
              getTileUrl: function (t) {
                var e = this._map,
                  ...
                  h = d.Util.template(this._url, { s: this._getSubdomain(t) });
            ...
            (d.TileLayer.Canvas = d.TileLayer.extend({
              ...
              redraw: function () {
                for (var t in (this._map && (this._reset({ hard: !0 }), this._update()), this._tiles)) this._redrawTile(this._tiles[t]);
                return this;
              },
            ...
            (d.ImageOverlay = d.Class.extend({
              ...
              _initImage: function () {
                (this._image = d.DomUtil.create("img", "leaflet-image-layer")),
                  ...
                  this._updateOpacity(),
                  d.extend(this._image, { galleryimg: "no", onselectstart: d.Util.falseFn, onmousemove: d.Util.falseFn, onload: d.bind(this._onImageLoad, this), src: this._url });
              },
              _animateZoom: function (t) {
                var e = this._map,
                  ...
                  h = a._add(r._multiplyBy(0.5 * (1 - 1 / o)));
            ...
            (d.Icon.Default.imagePath = (function () {
              var t,
                ...
                i,
                o,
                n = a.getElementsByTagName("script"),
                s = /[\/^]leaflet[\-\._]?([\w\-\._]*)\.js\??/;
              for (t = 0, e = n.length; t < e; t++) if ((i = n[t].src).match(s)) return ((o = i.split(s)[0]) ? o + "/" : "") + "images";
            })()),
            (d.Marker = d.Class.extend({
              includes: d.Mixin.Events,
              options: { icon: new d.Icon.Default(), title: "", alt: "", clickable: !0, draggable: !1, keyboard: !0, zIndexOffset: 0, opacity: 1, riseOnHover: !1, riseOffset: 250 },
              initialize: function (t, e) {
              ...
              setLatLng: function (t) {
                return (this._latlng = d.latLng(t)), this.update(), this.fire("move", { latlng: this._latlng });
              },
              ...
              _initIcon: function () {
                var t = this.options,
                  ...
                  n = !1;
                o !== this._icon && (this._icon && this._removeIcon(), (n = !0), t.title && (o.title = t.title), t.alt && (o.alt = t.alt)),
            ...
            (d.Popup = d.Class.extend({
              ...
              _initLayout: function () {
                ...
                this.options.closeButton &&
                  (((t = this._closeButton = d.DomUtil.create("a", e + "-close-button", o)).href = "#close"), (t.innerHTML = "&#215;"), d.DomEvent.disableClickPropagation(t), d.DomEvent.on(t, "click", this._onCloseButtonClick, this));
            ...
            d.Marker.include({
              ...
              bindPopup: function (t, e) {
                ...
                return (
                  ...
                  t instanceof d.Popup ? (d.setOptions(t, e), (this._popup = t), (t._source = this)) : (this._popup = new d.Popup(e, this).setContent(t)),
                  this
                );
              },
            ...
            (d.FeatureGroup = d.LayerGroup.extend({
              ...
              addLayer: function (t) {
                return this.hasLayer(t)
                  ? this
                  : ("on" in t && t.on(d.FeatureGroup.EVENTS, this._propagateEvent, this),
              ...
              _propagateEvent: function (t) {
                (t = d.extend({ layer: t.target, target: this }, t)), this.fire(t.type, t);
              },
            })),
            ...
            (d.Path = d.Class.extend({
              includes: [d.Mixin.Events],
              statics: { CLIP_PADDING: ((B = ((d.Browser.mobile ? 1280 : 2e3) / Math.max(s.outerWidth, s.outerHeight) - 1) / 2), Math.max(0, Math.min(0.5, B))) },
            ...
            (d.Path = d.Path.extend({
              ...
              _fireMouseEvent: function (t) {
                if (this._map && this.hasEventListeners(t.type)) {
                  ...
                  this.fire(t.type, { latlng: n, layerPoint: o, containerPoint: i, originalEvent: t }), "contextmenu" === t.type && d.DomEvent.preventDefault(t), "mousemove" !== t.type && d.DomEvent.stopPropagation(t);
                }
              },
            })),
            d.Map.include({
              _initPathRoot: function () {
                this._pathRoot ||
                  ...
                  this.options.zoomAnimation && d.Browser.any3d
                    ? (d.DomUtil.addClass(this._pathRoot, "leaflet-zoom-animated"), this.on({ zoomanim: this._animatePathZoom, zoomend: this._endPathZoom }))
            ...
            d.Path.include({
              bindPopup: function (t, e) {
                return (
                  t instanceof d.Popup ? (this._popup = t) : ((this._popup && !e) || (this._popup = new d.Popup(e, this)), this._popup.setContent(t)),
                ...
                : d.Path.extend({
                    ...
                    _updateStyle: function () {
                      ...
                      (o.stroked = i.stroke),
                        (o.filled = i.fill),
                        i.stroke
                          ? (t || (((t = this._stroke = this._createElement("stroke")).endcap = "round"), o.appendChild(t)),
                          ...
                          : t && (o.removeChild(t), (this._stroke = null)),
                        i.fill ? (e || ((e = this._fill = this._createElement("fill")), o.appendChild(e)), (e.color = i.fillColor || i.color), (e.opacity = i.fillOpacity)) : e && (o.removeChild(e), (this._fill = null));
                    },
                    _updatePath: function () {
            ...
            (d.Path =
              (d.Path.SVG && !s.L_PREFER_CANVAS) || !d.Browser.canvas
                ? d.Path
                : d.Path.extend({
                ...
                : {
                    _initPathRoot: function () {
                      var t,
                        e = this._pathRoot;
                      e ||
                        (((e = this._pathRoot = a.createElement("canvas")).style.position = "absolute"),
            ...
            (d.LineUtil = {
              ...
              clipSegment: function (t, e, i, o) {
                var n,
                  s,
                  a,
                  r = o ? this._lastCode : this._getBitCode(t, i),
              ...
              _getEdgeIntersection: function (t, e, i, o) {
                var n = e.x - t.x,
                  ...
                  r = o.max;
                return 8 & i
                  ? new d.Point(t.x + (n * (r.y - t.y)) / s, r.y)
                  : 4 & i
                  ? new d.Point(t.x + (n * (a.y - t.y)) / s, a.y)
                  : 2 & i
                  ? new d.Point(r.x, t.y + (s * (r.x - t.x)) / n)
                  : 1 & i
                  ? new d.Point(a.x, t.y + (s * (a.x - t.x)) / n)
                  : void 0;
              },
            ...
            (d.PolyUtil.clipPolygon = function (t, e) {
              ...
              for (s = 0; s < 4; s++) {
                for (l = p[s], i = [], o = 0, n = (h = t.length) - 1; o < h; n = o++)
                  (a = t[o]),
                    (r = t[n]),
                    a._code & l
                      ? r._code & l || (((c = _._getEdgeIntersection(r, a, l, e))._code = _._getBitCode(c, e)), i.push(c))
                      : (r._code & l && (((c = _._getEdgeIntersection(r, a, l, e))._code = _._getBitCode(c, e)), i.push(c)), i.push(a));
                t = i;
              }
              return t;
            }),
            (d.Polygon = d.Polyline.extend({
              ...
              projectLatlngs: function () {
                ...
                if ((d.Polyline.prototype.projectLatlngs.call(this), (this._holePoints = []), this._holes))
                  for (t = 0, i = this._holes.length; t < i; t++) for (this._holePoints[t] = [], e = 0, o = this._holes[t].length; e < o; e++) this._holePoints[t][e] = this._map.latLngToLayerPoint(this._holes[t][e]);
              },
              setLatLngs: function (t) {
                ...
                ? {
                    _containsPoint: function (t, e) {
                      ...
                      for (d.Browser.touch && (h += 10), i = 0, s = this._parts.length; i < s; i++)
                        for (o = 0, n = (a = (r = this._parts[i]).length) - 1; o < a; n = o++) if ((e || 0 !== o) && d.LineUtil.pointToSegmentDistance(t, r[n], r[o]) <= h) return !0;
                      return !1;
                    },
                  }
                : {}
            ...
            (d.GeoJSON = d.FeatureGroup.extend({
              ...
              addData: function (t) {
                var e,
                  i,
                  o,
                  n = d.Util.isArray(t) ? t : t.features;
                if (n) {
            ...
            d.extend(d.GeoJSON, {
              geometryToLayer: function (t, e, i, o) {
                ...
                switch (((i = i || this.coordsToLatLng), h.type)) {
                  ...
                  case "GeometryCollection":
                    for (a = 0, r = h.geometries.length; a < r; a++) c.push(this.geometryToLayer({ geometry: h.geometries[a], type: "Feature", properties: t.properties }, e, i, o));
                    return new d.FeatureGroup(c);
                  default:
              ...
              getFeature: function (t, e) {
                return t.feature ? d.extend({}, t.feature, { geometry: e }) : d.GeoJSON.asFeature(e);
              },
          ...
          var I = {
            toGeoJSON: function () {
              return d.GeoJSON.getFeature(this, { type: "Point", coordinates: d.GeoJSON.latLngToCoords(this.getLatLng()) });
            },
          };
          d.Marker.include(I),
            d.Circle.include(I),
            ...
            d.Polyline.include({
              toGeoJSON: function () {
                return d.GeoJSON.getFeature(this, { type: "LineString", coordinates: d.GeoJSON.latLngsToCoords(this.getLatLngs()) });
              },
            }),
            d.Polygon.include({
              toGeoJSON: function () {
                var t,
                  e,
                  i,
                  o = [d.GeoJSON.latLngsToCoords(this.getLatLngs())];
                if ((o[0].push(o[0][0]), this._holes)) for (t = 0, e = this._holes.length; t < e; t++) (i = d.GeoJSON.latLngsToCoords(this._holes[t])).push(i[0]), o.push(i);
                return d.GeoJSON.getFeature(this, { type: "Polygon", coordinates: o });
              },
            }),
            (function () {
              function t(t) {
                return function () {
                  ...
                  return (
                    ...
                    d.GeoJSON.getFeature(this, { type: t, coordinates: e })
                  );
                };
              }
              d.MultiPolyline.include({ toGeoJSON: t("MultiLineString") }),
                d.MultiPolygon.include({ toGeoJSON: t("MultiPolygon") }),
                d.LayerGroup.include({
                  toGeoJSON: function () {
                    ...
                    return (
                      ...
                      n ? d.GeoJSON.getFeature(this, { geometries: o, type: "GeometryCollection" }) : { type: "FeatureCollection", features: o }
                    );
                  },
                });
            })(),
            ...
            (d.DomEvent = {
              addListener: function (t, e, i, o) {
                ...
                return t[h]
                  ...
                  : ((n = function (e) {
                    ...
                    d.Browser.pointer && 0 === e.indexOf("touch")
                      ? this.addPointerListener(t, e, n, r)
                      : (d.Browser.touch && "dblclick" === e && this.addDoubleTapListener && this.addDoubleTapListener(t, n, r),
                        "addEventListener" in t
                          ? "mousewheel" === e
                            ? (t.addEventListener("DOMMouseScroll", n, !1), t.addEventListener(e, n, !1))
              ...
              removeListener: function (t, e, i) {
                ...
                return s
                  ? (d.Browser.pointer && 0 === e.indexOf("touch")
                      ? this.removePointerListener(t, e, o)
                      : d.Browser.touch && "dblclick" === e && this.removeDoubleTapListener
              ...
              _getEvent: function () {
                var t = s.event;
                if (!t) for (var e = arguments.callee.caller; e && (!(t = e.arguments[0]) || s.Event !== t.constructor); ) e = e.caller;
                return t;
              },
            ...
            (d.Draggable = d.Class.extend({
              ...
              _onDown: function (t) {
                if (
                  ((this._moved = !1),
                  !t.shiftKey && (1 === t.which || 1 === t.button || t.touches) && (d.DomEvent.stopPropagation(t), !d.Draggable._disabled && (d.DomUtil.disableImageDrag(), d.DomUtil.disableTextSelection(), !this._moving)))
                ) {
              ...
              _onUp: function () {
                for (var t in (d.DomUtil.removeClass(a.body, "leaflet-dragging"), this._lastTarget && (d.DomUtil.removeClass(this._lastTarget, "leaflet-drag-target"), (this._lastTarget = null)), d.Draggable.MOVE))
                ...
                d.DomUtil.enableImageDrag(),
                  ...
                  this._moved && this._moving && (d.Util.cancelAnimFrame(this._animRequest), this.fire("dragend", { distance: this._newPos.distanceTo(this._startPos) })),
                  (this._moving = !1);
              },
            })),
            ...
            d.Map.mergeOptions({ dragging: !0, inertia: !d.Browser.android23, inertiaDeceleration: 3400, inertiaMaxSpeed: 1 / 0, inertiaThreshold: d.Browser.touch ? 32 : 18, easeLinearity: 0.25, worldCopyJump: !1 }),
                  ...
                  u.x && u.y
                    ? ((u = e._limitOffset(u, e.options.maxBounds)),
                      d.Util.requestAnimFrame(function () {
                        e.panBy(u, { duration: _, easeLinearity: r, noMoveStart: !0 });
                      }))
                    : e.fire("moveend");
                }
              },
            ...
            d.Map.mergeOptions({ touchZoom: d.Browser.touch && !d.Browser.android23, bounceAtZoomLimits: !0 }),
                  ...
                  (this._scale = i.distanceTo(o) / this._startDist),
                    ...
                    1 !== this._scale &&
                      ((!e.options.bounceAtZoomLimits && ((e.getZoom() === e.getMinZoom() && this._scale < 1) || (e.getZoom() === e.getMaxZoom() && this._scale > 1))) ||
                        (this._moved || (d.DomUtil.addClass(e._mapPane, "leaflet-touching"), e.fire("movestart").fire("zoomstart"), (this._moved = !0)),
                        d.Util.cancelAnimFrame(this._animRequest),
            ...
            d.Map.mergeOptions({ keyboard: !0, keyboardPanOffset: 80, keyboardZoomOffset: 1 }),
            ...
            (d.Handler.MarkerDrag = d.Handler.extend({
              ...
              _onDrag: function () {
                ...
                e && d.DomUtil.setPosition(e, i), (t._latlng = o), t.fire("move", { latlng: o }).fire("drag");
              },
              _onDragEnd: function (t) {
            ...
            (d.Control.Attribution = d.Control.extend({
              ...
              onAdd: function (t) {
                for (var e in ((this._container = d.DomUtil.create("div", "leaflet-control-attribution")), d.DomEvent.disableClickPropagation(this._container), t._layers))
            ...
            (d.Control.Scale = d.Control.extend({
              ...
              _updateImperial: function (t) {
                var e,
                  ...
                  s = this._iScale;
                n > 5280
                  ? ((e = n / 5280), (i = this._getRoundNum(e)), (s.style.width = this._getScaleWidth(i / e) + "px"), (s.innerHTML = i + " mi"))
                  : ((o = this._getRoundNum(n)), (s.style.width = this._getScaleWidth(o / n) + "px"), (s.innerHTML = o + " ft"));
              },
            ...
            (d.Control.Layers = d.Control.extend({
              ...
              _addItem: function (t) {
                ...
                t.overlay ? (((e = a.createElement("input")).type = "checkbox"), (e.className = "leaflet-control-layers-selector"), (e.defaultChecked = o)) : (e = this._createRadioElement("leaflet-base-layers", o)),
              ...
              _onInputClick: function () {
                ...
                for (this._handlingClick = !0, t = 0; t < n; t++)
                  (e = o[t]), (i = this._layers[e.layerId]), e.checked && !this._map.hasLayer(i.layer) ? this._map.addLayer(i.layer) : !e.checked && this._map.hasLayer(i.layer) && this._map.removeLayer(i.layer);
            ...
            (d.PosAnimation = d.Class.extend({
              ...
              run: function (t, e, i, o) {
                this.stop(),
                  ...
                  (this._newPos = e),
                  this.fire("start"),
                  (t.style[d.DomUtil.TRANSITION] = "all " + (i || 0.25) + "s cubic-bezier(0,0," + (o || 0.5) + ",1)"),
            ...
            d.Map.include({
              setView: function (t, e, i) {
                if (
                  ((e = e === r ? this._zoom : this._limitZoom(e)), (t = this._limitCenter(d.latLng(t), e, this.options.maxBounds)), (i = i || {}), this._panAnim && this._panAnim.stop(), this._loaded && !i.reset && !0 !== i) &&
                  (i.animate !== r && ((i.zoom = d.extend({ animate: i.animate }, i.zoom)), (i.pan = d.extend({ animate: i.animate }, i.pan))),
              ...
              panBy: function (t, e) {
                ...
                if ((this._panAnim || ((this._panAnim = new d.PosAnimation()), this._panAnim.on({ step: this._onPanTransitionStep, end: this._onPanTransitionEnd }, this)), e.noMoveStart || this.fire("movestart"), !1 !== e.animate)) {
                ...
                ? {
                    ...
                    _animateZoom: function (t, e, i, o, n, s, a) {
                      a || (this._animatingZoom = !0),
                        ...
                        d.Util.requestAnimFrame(function () {
                          this.fire("zoomanim", { center: t, zoom: e, origin: i, scale: o, delta: n, backwards: s }), setTimeout(d.bind(this._onZoomTransitionEnd, this), 250);
                        }, this);
                    },
            ...
            d.TileLayer.include({
              ...
              _prepareBgBuffer: function () {
                ...
                if (e && i > 0.5 && o < 0.5) return (t.style.visibility = "hidden"), void this._stopLoadingImages(t);
              ...
              _stopLoadingImages: function (t) {
                var e,
                  i,
                  o,
                  n = Array.prototype.slice.call(t.getElementsByTagName("img"));
            ...
            d.Map.include({
              ...
              locate: function (t) {
                if (((t = this._locateOptions = d.extend(this._defaultLocateOptions, t)), !navigator.geolocation)) return this._handleGeolocationError({ code: 0, message: "Geolocation not supported." }), this;
              ...
              _handleGeolocationResponse: function (t) {
                ...
                var l = { latlng: o, bounds: a, timestamp: t.timestamp };
      ...
      879: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"Ελληνικά","lang":"el","messages":{"loading":"Φόρτωση","wikipedia":"Από την Wikipedia, την ελεύθερη εγκυκλοπαίδεια","start":"Έναρξη περιήγησης"},"buttons":{"map_overview":"Επισκόπηση χάρτη","overview":"Επισκόπηση","backtostart":"Επιστροφή στην αρχή","collapse_toggle":"Απόκρυψη χάρτη","uncollapse_toggle":"Εμφάνιση χάρτη","swipe_to_navigate":"Κτυπήστε ελαφρά για περιήγηση<br><span class=\'vco-button\'>OK</span>"}}'
        );
      },
      194: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"English","lang":"en","messages":{"loading":"Loading","wikipedia":"From Wikipedia, the free encyclopedia","start":"Start Exploring"},"buttons":{"map_overview":"Map Overview","overview":"Overview","backtostart":"Restart Tour","collapse_toggle":"Hide Map","uncollapse_toggle":"Show Map","swipe_to_navigate":"Swipe Right to Navigate<br><span class=\'vco-button\'>OK</span>"}}'
        );
      },
      299: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"Español","lang":"es","messages":{"loading":"cargando","wikipedia":"de Wikipedia, la enciclopedia libre","start":"Explore"},"buttons":{"map_overview":"vista general del mapa","overview":"vista general","backtostart":"volver al comienzo","collapse_toggle":"ocultar mapa","uncollapse_toggle":"mostrar mapa","swipe_to_navigate":"Deslizar para navegar<br><span class=\'vco-button\'>Entendido</span>"}}'
        );
      },
      475: (t) => {
        "use strict";
      ...
      68: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"Magyar","lang":"hu","messages":{"loading":"töltés","wikipedia":"Wikipedia","start":"Indítsd"},"buttons":{"map_overview":"teljes térkép","overview":"teljes sztori","backtostart":"vissza az elejére","collapse_toggle":"összecsuk","uncollapse_toggle":"kinyit","swipe_to_navigate":"Húzd el a navigációhoz<br><span class=\'vco-button\'>OK</span>"}}'
        );
      },
      374: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"Icelandic","lang":"is","messages":{"loading":"Hleðsla","wikipedia":"Frá Wikipedia","start":"Hefja"},"buttons":{"map_overview":"Kortayfirlit","overview":"Yfirlit","backtostart":"Hefja aftur","collapse_toggle":"Fela kortið","uncollapse_toggle":"Sýna kortið","swipe_to_navigate":"Strjúktu fyrir valmynd<br><span class=\'vco-button\'>Allt í lagi</span>"}}'
        );
      },
      130: (t) => {
        "use strict";
      ...
      830: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"Türkçe","lang":"tr","messages":{"loading":"Yükleniyor","wikipedia":"Vikipedi, Özgür Ansiklopedi","start":"Keşfet"},"buttons":{"map_overview":"Genel harita","overview":"Genel harita","backtostart":"Başlangıç menüsüne dön","collapse_toggle":"Menüyü gizle","uncollapse_toggle":"Menüyü göster","swipe_to_navigate":"Dokun ve kaydır<br><span class=\'vco-button\'>OK</span>"}}'
        );
      },
      362: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"Українська","lang":"uk","messages":{"loading":"Завантаження","wikipedia":"З Вікіпедії, вільної енциклопедії","start":"Почати перегляд"},"buttons":{"map_overview":"Перегляд карти","overview":"Огляд","backtostart":"Повернутися до початку","collapse_toggle":"Приховати карту","uncollapse_toggle":"Показати карту","swipe_to_navigate":"Swipe to Navigate<br><span class=\'vco-button\'>OK</span>"}}'
        );
      },
      125: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"Urdu","lang":"ur","direction":"rtl","messages":{"loading":"لوڈ ہو رہا ہے","wikipedia":"ویکیپیڈیا, مفت دستیاب انسائیکلوپیڈیا سے ","start":"دریافت شروع کی جایے "},"buttons":{"map_overview":"نقشے کا جائزہ","overview":"جائزہ","backtostart":"واپس شروع سے","collapse_toggle":"نقشہ غائب","uncollapse_toggle":"نقشہ حاضر","swipe_to_navigate":"Swipe to Navigate<br><span class=\'vco-button\'>OK</span>"}}'
        );
      },
      814: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"中文","lang":"zh-cn","messages":{"loading":"加载中","wikipedia":"来自维基百科，自由的百科全书","start":"Explore"},"buttons":{"map_overview":"地图总览","overview":"总览","backtostart":"回到首页","collapse_toggle":"隐藏地图","uncollapse_toggle":"显示地图","swipe_to_navigate":"Swipe to Navigate<br><span class=\'vco-button\'>OK</span>"}}'
        );
      },
      220: (t) => {
        "use strict";
        t.exports = JSON.parse(
          '{"name":"正體中文","lang":"zh-tw","messages":{"loading":"載入中","wikipedia":"來自維基百科，自由的百科全書","start":"探索"},"buttons":{"map_overview":"地圖總覽","overview":"總覽","backtostart":"回到首頁","collapse_toggle":"隱藏地圖","uncollapse_toggle":"顯示地圖","swipe_to_navigate":"左右滑動以瀏覽<br><span class=\'vco-button\'>我知道了</span>"}}'
        );
      },
      329: (t, e, i) => {
        var o = {
  ...
  (() => {
    "use strict";
    i.r(o), i.d(o, { MediaType: () => Pt, StamenTileLayer: () => it, StoryMap: () => Et, ZoomifyTileLayer: () => G, loadCSS: () => B, setLanguage: () => j });
    ...
    function k(t) {
      for (var e, i = Array.prototype.slice.call(arguments, 1), o = 0, n = i.length; o < n; o++) for (var s in (e = i[o] || {})) e.hasOwnProperty(s) && (t[s] = e[s]);
      return t;
    }
    function P(t, ...e) {
      for (let o of e) for (var i of Object.getOwnPropertyNames(o.prototype)) t.prototype[i] = o.prototype[i];
    }
    function T(t, e) {
      var i;
    ...
    let A = new (class {
      constructor(t) {
        (this.doc = t), (this.pending = {}), (this.queue = { css: [], js: [] }), (this.styleSheets = t.styleSheets), (this.env = this.getEnv()), (this.head = this.doc.head || this.doc.getElementsByTagName("head")[0]), (this.pollCount = 0);
      }
      createNode(t, e) {
        var i,
          o = this.doc.createElement(t);
      ...
      load(t, e, i, o, n) {
        var s,
          ...
          _ = [];
        if (e)
          if (((e = "string" == typeof e ? [e] : e.concat()), p || this.env.async || this.env.gecko || this.env.opera)) this.queue[t].push({ urls: e, callback: i, obj: o, context: n });
          else for (s = 0, a = e.length; s < a; ++s) this.queue[t].push({ urls: [e[s]], callback: s === a - 1 ? i : null, obj: o, context: n });
        if (!this.pending[t] && (h = this.pending[t] = this.queue[t].shift())) {
          for (s = 0, a = (l = h.urls).length; s < a; ++s)
            (c = l[s]),
              p ? (r = this.env.gecko ? this.createNode("style") : this.createNode("link", { href: c, rel: "stylesheet" })) : ((r = this.createNode("script", { src: c })).async = !1),
              ...
              this.env.ie && !p
                ...
                : p && (this.env.gecko || this.env.webkit)
                ? this.env.webkit
                  ? ((h.urls[s] = r.href), this.pollWebKit())
                  : ((r.innerHTML = '@import "' + c + '";'), this.pollGecko(r))
                : (r.onload = r.onerror = d),
              _.push(r);
    ...
    class I {
      ...
      static setPosition(t, e) {
        (t._vco_pos = e),
          Browser.webkit3d
            ? ((t.style[I.TRANSFORM] = I.getTranslateString(e)), Browser.android && ((t.style["-webkit-perspective"] = "1000"), (t.style["-webkit-backface-visibility"] = "hidden")))
    ...
    class W {
      on(t, e, i) {
        ...
        return (o[t] = o[t] || []), o[t].push({ action: e, context: i || this }), this;
      }
      hasEventListeners(t) {
        var e = "_vco_events";
      ...
      off(t, e, i) {
        if (!this.hasEventListeners(t)) return this;
        for (var o = 0, n = this._vco_events, s = n[t].length; o < s; o++) if (n[t][o].action === e && (!i || n[t][o].context === i)) return n[t].splice(o, 1), this;
        return this;
      }
      fire(t, e) {
        if (!this.hasEventListeners(t)) return this;
        for (var i = k({ type: t, target: this }, e), o = this._vco_events[t].slice(), n = 0, s = o.length; n < s; n++) o[n].action.call(o[n].context || this, i);
        return this;
      }
    }
    i(243);
    class F {
      ...
      animatePosition(t, e, i) {
        var o = { duration: this.options.duration, easing: this.options.ease };
    ...
    class H {
      constructor(t, e, i) {
        (this._el = { container: {}, map: {}, map_mask: {} }),
          (this._el.container = "object" == typeof t ? t : I.get(t)),
          (this._loaded = { data: !1, map: !1 }),
          (this._map = null),
          (this._mini_map = null),
          (this._markers = []),
          ...
          (this.data = { uniqueid: "", slides: [{ test: "yes" }, { test: "yes" }, { test: "yes" }] }),
          (this.options = {
            ...
            map_subdomains: "",
            map_access_token: "",
            zoomify: { path: "", width: "", height: "", tolerance: 0.8, attribution: "" },
            skinny_size: 650,
            less_bounce: !0,
            path_gfx: "gfx",
            start_at_slide: 0,
        ...
        if (t < this._markers.length && t >= 0) {
          ...
          if ((this.animator && this.animator.stop(), this._resetMarkersActive(), n.data.type && "overview" == n.data.type)) this._markerOverview(), e || this._onMarkerChange();
            ...
            if (n.data.location && n.data.location.lat)
              if (((i = this._calculateZoomChange(this._getMapCenter(!0), n.location())), this._viewTo(n.data.location, { calculate_zoom: this.options.calculate_zoom, zoom: i }), this.options.line_follows_path)) {
                if (this.options.show_history_line && n.data.real_marker && this._markers[o].data.real_marker) {
                  var s,
                    a = [],
                    r = o;
                  if (r < this.current_marker)
                    for (; r < this.current_marker; ) this._markers[r].data.location && this._markers[r].data.location.lat && ((s = { lat: this._markers[r].data.location.lat, lon: this._markers[r].data.location.lon }), a.push(s)), r++;
                  else if (r > this.current_marker)
                    for (; r > this.current_marker; ) this._markers[r].data.location && this._markers[r].data.location.lat && ((s = { lat: this._markers[r].data.location.lat, lon: this._markers[r].data.location.lon }), a.push(s)), r--;
                  a.push({ lat: n.data.location.lat, lon: n.data.location.lon }), this._replaceLines(this._line_active, a);
                }
              } else
                this.options.show_history_line &&
                  n.data.real_marker &&
                  this._markers[o].data.real_marker &&
                  this._replaceLines(this._line_active, [
                    { lat: n.data.location.lat, lon: n.data.location.lon },
                    { lat: this._markers[o].data.location.lat, lon: this._markers[o].data.location.lon },
                  ]);
      ...
      _initLayout() {
        (this._el.map_mask = I.create("div", "vco-map-mask", this._el.container)),
          this.options.map_as_image ? (this._el.map = I.create("div", "vco-map-display vco-mapimage-display", this._el.map_mask)) : (this._el.map = I.create("div", "vco-map-display", this._el.map_mask));
      }
      _initData() {
    ...
    P(H, W, F);
    let V = { continuousWorld: !0, tolerance: 0.8 };
    class G extends L.TileLayer {
      ...
      getCenterZoom(t) {
        ...
        return { center: a, lat: a.lat, lon: a.lng, zoom: i };
      }
      _getGridSize(t) {
    ...
    const q = {
      ...
      width: 150,
      height: 150,
      aimingRectOptions: { color: "#c34528", weight: 1, clickable: !1, stroke: !0 },
      shadowRectOptions: { color: "#000000", weight: 1, clickable: !1, opacity: 0, fillOpacity: 0 },
    };
    class J extends L.Control {
          ...
          this._miniMap.whenReady(
            L.Util.bind(function () {
              (this._aimingRect = L.rectangle(this._mainMap.getBounds(), this.options.aimingRectOptions).addTo(this._miniMap)),
                ...
                (this._locationCircle = L.circleMarker(this._mainMap.getCenter(), { fillColor: "#c34528", color: "#FFFFFF", weight: 2, radius: 10, fill: !0, fillOpacity: 1, stroke: !0, clickable: !1 }).addTo(this._miniMap)),
                this._locationCircle.setRadius(5),
                this._mainMap.on("moveend", this._onMainMapMoved, this),
                this._mainMap.on("move", this._onMainMapMoving, this),
                this.options.bounds_array && this._miniMap.fitBounds(this.options.bounds_array, { padding: [15, 15] });
            }, this)
          ),
          this._container
        );
      ...
      restore() {
        this._minimized && (this._restore(), this._miniMap.fitBounds(this.options.bounds_array, { padding: [15, 15] }));
      }
      addTo(t) {
      ...
      _decideZoom(t) {
        ...
        return (
          i > this.options.zoomLevelOffset && this._mainMap.getZoom() < this._miniMap.getMinZoom() - this.options.zoomLevelOffset
            ? this._miniMap.getZoom() > this._lastMiniMapZoom
              ? ((e = this._mainMap.getZoom() + 1), this._miniMap.setZoom(this._miniMap.getZoom() - 1))
    ...
    L.Map.mergeOptions({ miniMapControl: !1 }),
    ...
    class K {
      constructor(t, e) {
        (this._el = { container: {}, content_container: {}, content: {} }),
          ...
          (this.timer = {}),
          (this.data = {}),
          (this.options = { duration: 1e3, ease: U.easeInSpline, width: 600, height: 600, map_popup: !1 }),
          (this.animator = null),
          T(this.options, e),
          T(this.data, t),
          this._initLayout();
    ...
    class Y extends K {
      _createMarker(t, e) {
        if (t.location && "number" == typeof t.location.lat && "number" == typeof t.location.lon) {
          ...
          i && t.location.icon
            ? ((this._custom_icon = { url: t.location.icon, size: t.location.iconSize || [48, 48], anchor: this._customIconAnchor(t.location.iconSize) }), (this._icon = this._createIcon()))
            : i && t.location.image
            ? ((this._custom_image_icon = t.location.image), (this._icon = this._createImage()))
            : (this._icon = this._createDefaultIcon(!1)),
            (this._marker = new L.marker([t.location.lat, t.location.lon], { title: t.text.headline, icon: this._icon })),
      ...
      _active(t) {
        this.data.media && this.data.media.mediatype ? (this.media_icon_class = "vco-mapmarker-icon vco-icon-" + this.data.media.mediatype.type) : (this.media_icon_class = "vco-mapmarker-icon vco-icon-plaintext"),
          this.data.real_marker &&
            (t ? this._marker.setZIndexOffset(100) : (clearTimeout(this.timer), this._marker.setZIndexOffset(0)),
      ...
      _createImage(t) {
        ...
        return new L.icon({ iconUrl: url, iconSize: [48], iconAnchor: [24, 48], shadowSize: [68, 95], shadowAnchor: [22, 94], className: e });
      }
      _createDefaultIcon(t) {
        var e = t ? "vco-mapmarker-active" : "vco-mapmarker";
        return L.divIcon({ className: e + " " + this.media_icon_class, iconAnchor: [10, 10] });
      }
      _customIconAnchor(t) {
        return t ? [0.5 * t[0], t[1]] : [24, 48];
      }
      _openPopup() {
    ...
    class it extends L.TileLayer {
      constructor(t, e) {
        ...
        var i = et(t),
          ...
          n = { minZoom: i.minZoom, maxZoom: i.maxZoom, subdomains: i.subdomains, scheme: "xyz", attribution: i.attribution };
        e && T(n, e), L.TileLayer.prototype.initialize.call(this, o, n);
      }
    }
    class ot extends H {
      _createMap() {
        (this._map = new L.map(this._el.map, { scrollWheelZoom: !1, zoomControl: !this.options.map_mini })),
        ...
        (this._tile_layer = this._createTileLayer(this.options.map_type)),
          ...
          this.options.map_as_image && (this._line_active.setStyle({ opacity: 0 }), this._line.setStyle({ opacity: 0 }));
      }
      _createMiniMap() {
        this.options.map_as_image && (this.zoom_min_max.min = 0),
          ...
          (this._mini_map = new J(this._tile_layer_mini, {
            width: 150,
            height: 100,
            position: "topleft",
            ...
            zoomAnimation: !0,
            aimingRectOptions: { fillColor: "#FFFFFF", color: "#FFFFFF", opacity: 0.4, weight: 1, stroke: !0 },
          }).addTo(this._map)),
      ...
      _createBackgroundMap(t) {
        if ((this._image_layer ? this._image_layer.clearLayers() : ((this._image_layer = new L.layerGroup()), this._map.addLayer(this._image_layer)), t))
          for (let s in t) {
            var e,
              i = t[s],
              o = { x: 0, y: 0, url: i.src, height: parseInt(i.style.height.split("px")[0]), width: parseInt(i.style.width.split("px")[0]), pos: { start: 0, end: 0 } };
            if (i.style.left || i.style.top) i.style.left && (o.x = parseInt(i.style.left.split("px")[0])), i.style.top && (o.y = parseInt(i.style.top.split("px")[0]));
              ...
              var n;
              i.style["-webkit-transform"]
                ? (n = i.style["-webkit-transform"].split("3d(")[1].split(", 0)")[0].split(", "))
                : i.style.transform
                ? (n = i.style.transform.split("3d(")[1].split(", 0)")[0].split(", "))
            ...
            o.url.match("toner") && ((o.url = o.url.replace("/toner-hybrid/", "/toner-lines/")), (o.url = o.url.replace("/toner/", "/toner-background/"))),
      ...
      _createTileLayer(t, e) {
        ...
        switch ((e && (n = e), o[0])) {
          case "mapbox":
            var a;
            if (((n.attribution = s + "<div class='mapbox-maplogo'></div><a href='https://www.mapbox.com/about/maps/' target='_blank'>© Mapbox © OpenStreetMap</a>"), o.length > 2))
              a = "https://api.mapbox.com/styles/v1/" + o[2].substr("//styles/".length) + "/tiles/256/{z}/{x}/{y}@2x?access_token=" + this.options.map_access_token;
          ...
          case "stamen":
            ...
            break;
          case "zoomify":
            (n.width = this.options.zoomify.width),
              (n.height = this.options.zoomify.height),
              (n.tolerance = this.options.zoomify.tolerance || 0.9),
              (n.attribution = s + this.options.zoomify.attribution),
              (i = new G(this.options.zoomify.path, n));
            break;
          case "osm":
            (n.subdomains = "ab"),
              (n.attribution = s + "© <a target='_blank' href='http://www.openstreetmap.org'>OpenStreetMap</a> and contributors, under an <a target='_blank' href='http://www.openstreetmap.org/copyright'>open license</a>"),
              (i = new L.TileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", n));
            break;
          case "http":
          case "https":
      ...
      _markerOverview() {
        var t, e;
        if ((this._line_active.setStyle({ opacity: 0 }), "zoomify" == this.options.map_type && this.options.map_as_image)) {
          var i = this._tile_layer.getCenterZoom(this._map);
          (t = i.center),
            ((this.options.map_center_offset && 0 != this.options.map_center_offset.left) || 0 != this.options.map_center_offset.top) && ((i.zoom = i.zoom - 1), (t = this._getMapCenterOffset(t, i.zoom))),
            this._map.setView(t, i.zoom, { pan: { animate: !0, duration: this.options.duration / 1e3, easeLinearity: 0.1 }, zoom: { animate: !0, duration: this.options.duration / 1e3, easeLinearity: 0.1 } });
          ...
          (t = o.getCenter()),
            ...
            this._map.setView(t, e - 1, { pan: { animate: !0, duration: this.options.duration / 1e3, easeLinearity: 0.1 }, zoom: { animate: !0, duration: this.options.duration / 1e3, easeLinearity: 0.1 } });
        } else this._map.fitBounds(this.bounds_array, { padding: [15, 15] });
      ...
      _createLine(t) {
        ...
        // });
        return new L.GeoJSON(this.options.line_data, {
          // clickable: !1,
          style:{
            color: this.options.line_color,
            weight: this.options.line_weight,
      ...
      _addToLine(t, e) {
        // t.addLatLng({ lon: e.location.lon, lat: e.location.lat });
      }
      _replaceLines(t, e) {
        t.setLatLngs(e);
      }
      _panTo(t, e) {
        this._map.panTo({ lat: t.lat, lon: t.lon }, { animate: !0, duration: this.options.duration / 1e3, easeLinearity: 0.1 });
      }
      _zoomTo(t, e) {
        this._map.setZoom(t);
      }
      _viewTo(t, e) {
        var i = !0,
          ...
          n = this._getMapZoom(), 
          //kuni's to get current zoom
          // n=24,
          s = { lat: t.lat, lon: t.lon };
        // console.log(e.zoom)
        this.options.map_as_image || this._line_active.setStyle({ opacity: 1 }),
          t.zoom && (n = t.zoom),
          e && (e.duration && (0 == e.duration ? (i = !1) : (o = duration)), e.zoom && this.options.calculate_zoom && (n = e.zoom)),
          this.options.map_center_offset && (s = this._getMapCenterOffset(s, n)),
          this._map.setView(s, n, { pan: { animate: i, duration: o, easeLinearity: 0.1 }, zoom: { animate: i, duration: o, easeLinearity: 0.1 } }),
      ...
      _refreshMap() {
        this._map &&
          ...
          this._markers[this.current_marker].data.type && "overview" == this._markers[this.current_marker].data.type ? this._markerOverview() : this._viewTo(this._markers[this.current_marker].data.location, { zoom: this._getMapZoom() }));
      }
    }
    P(ot, W),
      L.Map.include({
        ...
        getBoundsZoom: function (t, e, i) {
          ...
          for (var p = 0; p < s; p++) n++, (o = this.project(h, n).subtract(this.project(r, n)).add(i)), l.push({ x: Math.abs(a.x - o.x), y: Math.abs(a.y - o.y) });
          d = l[0];
    ...
    class nt {
      constructor(t, e, i) {
        (this._el = { drag: t, move: t }),
          i && (this._el.move = i),
          (this.options = { enable: { x: !0, y: !0 }, constraint: { top: !1, bottom: !1, left: !1, right: !1 }, momentum_multiplier: 2e3, duration: 1e3, ease: VCO.Ease.easeInOutQuint }),
          (this.animator = null),
      ...
      _animateMomentum() {
        var t = { x: this.data.new_pos.x, y: this.data.new_pos.y },
          e = { duration: this.options.duration, easing: VCO.Ease.easeOutStrong };
        this.options.enable.y &&
          ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? (t.y = this.options.constraint.bottom) : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)),
          (e.top = Math.floor(t.y) + "px")),
          this.options.enable.x &&
            ((this.options.constraint.left || this.options.constraint.right) && (t.x > this.options.constraint.left ? (t.x = this.options.constraint.left) : t.x < this.options.constraint.right && (t.x = this.options.constraint.right)),
    ...
    class at {
      constructor(t, e, i) {
        (this._el = { parent: {}, container: {}, button_overview: {}, button_backtostart: {}, button_collapse_toggle: {}, arrow: {}, line: {}, coverbar: {}, grip: {} }),
          (this.collapsed = !1),
          (this._el.container = "object" == typeof t ? t : I.get(t)),
          e && (this._el.parent = e),
          (this.options = { width: 600, height: 600, duration: 1e3, ease: U.easeInOutQuint, menubar_default_y: 0 }),
          (this.animator = {}),
          T(this.options, i),
          this._initLayout(),
          this._initEvents();
      ...
      _onButtonCollapseMap(t) {
        this.collapsed
          ? ((this.collapsed = !1),
            ...
            (this._el.button_collapse_toggle.innerHTML = b ? "<span class='vco-icon-arrow-up'></span>" : R.buttons.collapse_toggle + "<span class='vco-icon-arrow-up'></span>"))
          : ((this.collapsed = !0),
            this.hide(25),
      ...
      _initLayout() {
        (this._el.button_overview = I.create("span", "vco-menubar-button", this._el.container)),
          st.addListener(this._el.button_overview, "click", this._onButtonOverview, this),
          (this._el.button_backtostart = I.create("span", "vco-menubar-button", this._el.container)),
    ...
    const ht = (function () {
      var t = document,
        ...
        m = { lineHeight: 1, zoom: 1, zIndex: 1, opacity: 1, transform: 1 },
        g = (function () {
          var e,
            i = t.createElement("a").style,
            o = ["webkitTransform", "MozTransform", "OTransform", "msTransform", "Transform"];
          for (e = 0; e < o.length; e++) if (o[e] in i) return o[e];
        })(),
      ...
      function x(t, e) {
        var i,
          o = {};
        return (
          (i = t.match(d)) && (o.rotate = O(i[1], e ? e.rotate : null)),
          (i = t.match(p)) && (o.scale = O(i[1], e ? e.scale : null)),
          (i = t.match(_)) && ((o.skewx = O(i[1], e ? e.skewx : null)), (o.skewy = O(i[3], e ? e.skewy : null))),
          (i = t.match(u)) && ((o.translatex = O(i[1], e ? e.translatex : null)), (o.translatey = O(i[3], e ? e.translatey : null))),
          o
        );
      }
      function M(t) {
      ...
      function C(t, e) {
        ...
        for (o = 1; o < n; ++o) for (i = 0; i < n - o; ++i) (s[i][0] = (1 - e) * s[i][0] + e * s[parseInt(i + 1, 10)][0]), (s[i][1] = (1 - e) * s[i][1] + e * s[parseInt(i + 1, 10)][1]);
        return [s[0][0], s[0][1]];
      }
      function E(t, e, i, o, n, s, a) {
        ...
        return "string" == typeof i[s][n]
          ...
          : ((a = Math.round(((o[s][n] - i[s][n]) * t + i[s][n]) * r) / r), n in m || (a += e[s][n] || "px"), a);
      }
        ...
        for (d && ((o = e.left), (n = e.top), delete e.right, delete e.bottom, delete e.left, delete e.top), i = s.length; i--; ) {
          ...
          for (var L in e) {
            ...
            var D,
              z = v(s[i], L),
              B = T(e[L]) ? e[L](s[i]) : e[L];
            "string" != typeof B || !h.test(B) || h.test(z)
              ? ((p[i][L] = "transform" == L ? x(z) : "string" == typeof B && h.test(B) ? k(z).slice(1) : parseFloat(z)),
                (_[i][L] = "transform" == L ? x(B, p[i][L]) : "string" == typeof B && "#" == B.charAt(0) ? k(B).slice(1) : O(B, parseFloat(z))),
                "string" == typeof B && (D = B.match(c)) && (u[i][L] = D[1]))
              : delete e[L];
          }
        }
        return S.apply(s, [
          ...
          function (t, o, n) {
            for (i = s.length; i--; )
              for (var a in (d && ((n = C(m[i], t)), (s[i].style.left = n[0] + "px"), (s[i].style.top = n[1] + "px")), e))
                (o = E(t, u, p, _, a, i)), "transform" == a ? (s[i].style[g] = M(o)) : "opacity" != a || f ? (s[i].style[P(a)] = o) : (s[i].style.filter = "alpha(opacity=" + 100 * o + ")");
          },
          a,
          l,
        ]);
    ...
    class lt {
      constructor(t, e, i) {
        (this._el = { container: {}, content_container: {}, icon: {}, title: {}, description: {} }),
          ...
          T(this.options, e),
          T(this.data, t),
          (this._el.container = I.create("div", "vco-slidenav-" + this.options.direction)),
      ...
      _initLayout() {
        (this._el.content_container = I.create("div", "vco-slidenav-content-container", this._el.container)),
          (this._el.icon = I.create("div", "vco-slidenav-icon", this._el.content_container)),
          (this._el.title = I.create("div", "vco-slidenav-title", this._el.content_container)),
          (this._el.description = I.create("div", "vco-slidenav-description", this._el.content_container)),
    ...
    class ct {
      constructor(t, e, i) {
        (this._el = { parent: {}, container: {}, message_container: {}, loading_icon: {}, message: {} }),
          (this.options = { width: 600, height: 600, message_class: "vco-message", message_icon_class: "vco-loading-icon" }),
          T(this.data, t),
          T(this.options, e),
          (this._el.container = I.create("div", this.options.message_class)),
      ...
      _initLayout() {
        (this._el.message_container = I.create("div", "vco-message-container", this._el.container)),
          (this._el.loading_icon = I.create("div", this.options.message_icon_class, this._el.message_container)),
          (this._el.message = I.create("div", "vco-message-content", this._el.message_container)),
          this._updateMessage();
      }
      _initEvents() {
        st.addListener(this._el.container, "click", this._onMouseClick, this);
    ...
    class dt {
      constructor(t, e, i) {
        (this._el = { container: {}, content_container: {}, content: {}, content_item: {}, content_link: {}, caption: null, credit: null, parent: {}, link: null }),
          ...
          (this.data = { uniqueid: null, url: null, credit: null, caption: null, link: null, link_target: null }),
          (this.options = { api_key_flickr: "8f2d5becf7b6ba46570741620054b507", credit_height: 0, caption_height: 0 }),
          (this.animator = {}),
          T(this.options, e),
          T(this.data, t),
          (this._el.container = I.create("div", "vco-media")),
      ...
      updateMediaDisplay(t) {
        this._state.loaded &&
          ...
          this._state.media_loaded && (this._el.credit && (this._el.credit.style.width = "auto"), this._el.caption && (this._el.caption.style.width = "auto")),
          w &&
            (this._el.content_item.offsetWidth > this._el.content_item.offsetHeight && ((this._el.content_item.style.width = "100%"), (this._el.content_item.style.maxWidth = "100%")),
      ...
      loadErrorDisplay(t) {
        this._el.content.removeChild(this._el.content_item),
          (this._el.content_item = I.create("div", "vco-media-item vco-media-loaderror", this._el.content)),
      ...
      showMeta(t, e) {
        (this._state.show_meta = !0),
          this.data.credit &&
            "" != this.data.credit &&
            !this._el.credit &&
            ((this._el.credit = I.create("div", "vco-credit", this._el.content_container)), (this._el.credit.innerHTML = this.data.credit), (this.options.credit_height = this._el.credit.offsetHeight)),
          this.data.caption &&
            "" != this.data.caption &&
            !this._el.caption &&
            ((this._el.caption = I.create("div", "vco-caption", this._el.content_container)), (this._el.caption.innerHTML = this.data.caption), (this.options.caption_height = this._el.caption.offsetHeight));
      }
      onAdd() {
        this.fire("added", this.data);
      }
      ...
      _initLayout() {
        (this.message = new ct({}, this.options)),
          ...
          (this._el.content_container = I.create("div", "vco-media-content-container", this._el.container)),
          this.data.link && "" != this.data.link
            ? ((this._el.link = I.create("a", "vco-media-link", this._el.content_container)),
              (this._el.link.href = this.data.link),
              this.data.link_target && "" != this.data.link_target ? (this._el.link.target = this.data.link_target) : (this._el.link.target = "_blank"),
              (this._el.content = I.create("div", "vco-media-content", this._el.link)))
            : (this._el.content = I.create("div", "vco-media-content", this._el.content_container));
      }
      _updateDisplay(t, e, i) {
    ...
    class pt extends dt {
      _loadMedia() {
        var t = this;
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          this.data.link
            ? ((this._el.content_link = I.create("a", "", this._el.content)),
              (this._el.content_link.href = this.data.link),
              (this._el.content_link.target = "_blank"),
              (this._el.content_item = I.create("img", "vco-media-item vco-media-image vco-media-shadow", this._el.content_link)))
            : (this._el.content_item = I.create("img", "vco-media-item vco-media-image vco-media-shadow", this._el.content)),
    ...
    class _t extends dt {
      _loadMedia() {
        ...
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          ...
          (this._el.content_item = I.create("div", "vco-media-item vco-media-youtube vco-media-shadow", this._el.content)),
          (this._el.content_item.id = S(7)),
          (t = (function (t) {
            var e,
              i,
              o,
          ...
          z("https://www.youtube.com/iframe_api", function () {
            e.createMedia();
          });
      }
      _updateMediaDisplay() {
        this._el.content_item.style.height = O({ w: this._el.content_item.offsetWidth }) + "px";
      }
      _stopMedia() {
        ...
        clearTimeout(this.timer),
          "undefined" != typeof YT && void 0 !== YT.Player
            ? (this.player = new YT.Player(this._el.content_item.id, {
                playerVars: { enablejsapi: 1, color: "white", autohide: 1, showinfo: 0, theme: "light", start: this.media_id.start, fs: 0, rel: 0 },
    ...
    class ut extends dt {
      _loadMedia() {
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          (this._el.content_item = I.create("div", "vco-media-item vco-media-blockquote", this._el.content)),
    ...
    class mt extends dt {
      _loadMedia() {
        var t,
          ...
          i = this;
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          (this._el.content_item = I.create("div", "vco-media-item vco-media-wikipedia", this._el.content)),
      ...
      createMedia(t) {
        ...
        if (t.query) {
          var i;
          ((e = { entry: {}, title: "", text: "", extract: "", paragraphs: 1, text_array: [] }).entry = (function (t, e) {
            if (void 0 !== t) {
              var i = 0;
              for (var o in t) {
                if (e === i) return t[o];
          ...
          (i = "<h4><a href='" + this.data.url + "' target='_blank'>" + e.title + "</a></h4>"),
            (i += "<span class='wiki-source'>" + R.messages.wikipedia + "</span>"),
            (i += e.text),
    ...
    class gt extends dt {
      _loadMedia() {
        var t,
          e = this;
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          (this._el.content_item = I.create("div", "vco-media-item vco-media-iframe vco-media-soundcloud vco-media-shadow", this._el.content)),
          (this.media_id = this.data.url),
    ...
    class ft extends dt {
      _loadMedia() {
        var t;
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          (this._el.content_item = I.create("div", "vco-media-item vco-media-iframe vco-media-vimeo vco-media-shadow", this._el.content)),
          (this.media_id = this.data.url.split(/video\/|\/\/vimeo\.com\//)[1].split(/[?&]/)[0]),
          (t = "https://player.vimeo.com/video/" + this.media_id + "?api=1&title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff"),
          (this.player = I.create("iframe", "", this._el.content_item)),
    ...
    class vt extends dt {
      _loadMedia() {
        var t;
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          (this._el.content_item = I.create("div", "vco-media-item vco-media-iframe vco-media-dailymotion", this._el.content)),
    ...
    class yt extends dt {
      _loadMedia() {
        var t;
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          (this._el.content_item = I.create("div", "vco-media-item vco-media-iframe vco-media-vine vco-media-shadow", this._el.content)),
      ...
      _updateMediaDisplay() {
        var t = E({ w: this._el.content_item.offsetWidth, h: this.options.height });
    ...
    class bt extends dt {
      _loadMedia() {
        var t,
          e = this;
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          (this._el.content_item = I.create("img", "vco-media-item vco-media-image vco-media-flickr vco-media-shadow", this._el.content)),
    ...
    class Lt extends dt {
      _loadMedia() {
        this.message.updateMessage(R.messages.loading + " " + this.options.media_name),
          (this._el.content_item = I.create("div", "vco-media-item vco-media-iframe", this._el.content)),
          (this.media_id = this.data.url),
          this.media_id,
          this.media_id.match(/docs.google.com/i)
    ...
    function Pt(t) {
      for (
        var e = {},
          i = [
            { type: "youtube", name: "YouTube", match_str: "(www.)?youtube|youtu.be", cls: _t },
            { type: "vimeo", name: "Vimeo", match_str: "(player.)?vimeo.com", cls: ft },
            { type: "dailymotion", name: "DailyMotion", match_str: "(www.)?dailymotion.com", cls: vt },
            { type: "vine", name: "Vine", match_str: "(www.)?vine.co", cls: yt },
            { type: "soundcloud", name: "SoundCloud", match_str: "(player.)?soundcloud.com", cls: gt },
            { type: "twitter", name: "Twitter", match_str: "(www.)?twitter.com", cls: wt },
            { type: "flickr", name: "Flickr", match_str: "flickr.com/photos", cls: bt },
            { type: "image", name: "Image", match_str: /jpg|jpeg|png|gif/i, cls: pt },
            {
              type: "googledocs",
              name: "Google Doc",
            ...
            { type: "wikipedia", name: "Wikipedia", match_str: "(www.)?wikipedia.org", cls: mt },
            { type: "iframe", name: "iFrame", match_str: "iframe", cls: Mt },
            { type: "blockquote", name: "Quote", match_str: "blockquote", cls: ut },
            { type: "website", name: "Website", match_str: "https?://", cls: kt },
            { type: "", name: "", match_str: "", cls: dt },
          ],
          o = 0;
        o < i.length;
        o++
      ) {
        if (t instanceof Array) return { type: "slider", cls: xt };
    ...
    class Tt {
      constructor(t, e, i) {
        (this._el = { container: {}, content_container: {}, content: {}, headline: {}, date: {}, start_btn: {} }),
          (this.data = { uniqueid: "", headline: "headline", text: "text" }),
          (this.options = { title: !1 }),
          (function (t, e) {
            (t.data = k({}, t.data, e)), "" === t.data.uniqueid && (t.data.uniqueid = S(6));
          })(this, t),
          T(this.options, e),
          (this._el.container = I.create("div", "vco-text")),
        ...
        if ("" != this.data.text) {
          ...
          (e += C(this.data.text)),
            this.data.date &&
              ...
              "" != this.data.date.created_time &&
              this.data.date.created_time.length > 10 &&
              ("undefined" != typeof moment
                ? (e += "<div class='vco-text-date'>" + moment(this.data.date.created_time, "YYYY-MM-DD h:mm:ss").fromNow() + "</div>")
                : (e +=
                    ...
                    (function (t) {
                      ...
                      return (
                        (date = new Date(o[0], o[1], o[2], o[3], o[4], o[5])),
                    ...
                    "</div>")),
            (this._el.content = I.create("div", "vco-text-content", this._el.content_container)),
    ...
    class Dt {
      constructor(t, e, i) {
        (this._el = { container: {}, scroll_container: {}, background: {}, content_container: {}, content: {}, call_to_action: null }),
          (this._media = null),
          (this._mediaclass = {}),
          (this._text = {}),
          ...
          (this.has.title = i),
          (this.title = ""),
          (this.data = { uniqueid: null, background: null, date: null, location: null, text: null, media: null }),
          (this.options = { duration: 1e3, slide_padding_lr: 40, ease: U.easeInSpline, width: 600, height: 600, skinny_size: 650, media_name: "" }),
          (this.active = !1),
          (this.animator = {}),
          T(this.options, e),
          T(this.data, t),
      ...
      show() {
        this.animator = rt(this._el.slider_container, { left: -this._el.container.offsetWidth * n + "px", duration: this.options.duration, easing: this.options.ease });
      }
      hide() {}
      setActive(t) {
      ...
      addCallToAction(t) {
        (this._el.call_to_action = I.create("div", "vco-slide-calltoaction", this._el.content_container)),
      ...
      _initLayout() {
        (this._el.container = I.create("div", "vco-slide")),
          this.data.uniqueid && (this._el.container.id = this.data.uniqueid),
          (this._el.scroll_container = I.create("div", "vco-slide-scrollable-container", this._el.container)),
          (this._el.content_container = I.create("div", "vco-slide-content-container", this._el.scroll_container)),
          (this._el.content = I.create("div", "vco-slide-content", this._el.content_container)),
          (this._el.background = I.create("div", "vco-slide-background", this._el.container)),
          this.data.background &&
            ...
            this.data.background.color && ((this.has.background.color = !0), (this._el.container.className += " vco-full-color-background"), (this.has.background.color_value = this.data.background.color)),
          ...
          this.data.text && this.data.text.headline && ((this.has.headline = !0), (this.title = this.data.text.headline)),
          this.has.media &&
            ((this.data.media.mediatype = Pt(this.data.media)),
            (this.options.media_name = this.data.media.mediatype.name),
            (this.options.media_type = this.data.media.mediatype.type),
            (this._media = new this.data.media.mediatype.cls(this.data.media, this.options))),
          (this.has.text || this.has.headline) && (this._text = new Tt(this.data.text, { title: this.has.title })),
          this.has.text || this.has.headline || !this.has.media
            ? this.has.headline && this.has.media && !this.has.text
              ? ((this._el.container.className += " vco-slide-media-only"), this._text.addTo(this._el.content), this._media.addTo(this._el.content))
              : this.has.text && this.has.media
              ? (this._media.addTo(this._el.content), this._text.addTo(this._el.content))
              : (this.has.text || this.has.headline) && ((this._el.container.className += " vco-slide-text-only"), this._text.addTo(this._el.content))
            : ((this._el.container.className += " vco-slide-media-only"), this._media.addTo(this._el.content)),
          this.onLoaded();
      }
      _initEvents() {}
      _updateDisplay(t, e, i) {
        ...
        (this.options.width = t || this._el.container.offsetWidth),
          b && this.options.width <= this.options.skinny_size
            ? ((o = "0px"), (n = "0px"), (s = this.options.width - 0 + "px"))
            : "landscape" == i
            ? ((o = "40px"), (n = "75px"), (s = this.options.width - 115 + "px"))
            : (this.options.width, this.options.skinny_size, (o = this.options.slide_padding_lr + "px"), (n = this.options.slide_padding_lr + "px"), (s = this.options.width - 2 * this.options.slide_padding_lr + "px")),
          (this._el.content.style.paddingLeft = o),
          (this._el.content.style.paddingRight = n),
          (this._el.content.style.width = s),
          this._el.call_to_action && ((this._el.call_to_action.style.paddingLeft = o), (this._el.call_to_action.style.paddingRight = n), (this._el.call_to_action.style.width = s)),
    ...
    class St {
      constructor(t, e, i) {
        (this.mousedrag = { down: "mousedown", up: "mouseup", leave: "mouseleave", move: "mousemove" }),
          ...
          (this._el = { drag: t, move: t }),
          e && (this._el.move = e),
          (this.options = { snap: !1, enable: { x: !0, y: !0 }, constraint: { top: !1, bottom: !1, left: 0, right: !1 }, momentum_multiplier: 2e3, duration: 1e3, ease: U.easeInOutQuint }),
          (this.animator = null),
          (this.dragevent = this.mousedrag),
      ...
      _momentum() {
        ...
        (this.data.direction = null),
          ...
          i.x && (Math.abs(e.x) > this._el.drag.offsetWidth / 2 && (o = !0), Math.abs(e.x) > 1e4 && ((this.data.direction = "left"), e.x > 0 && (this.data.direction = "right"))),
          i.y && (Math.abs(e.y) > this._el.drag.offsetHeight / 2 && (o = !0), Math.abs(e.y) > 1e4 && ((this.data.direction = "up"), e.y > 0 && (this.data.direction = "down"))),
          this._animateMomentum(),
          o && this.data.direction
            ? this.fire("swipe_" + this.data.direction, this.data)
            : this.data.direction
            ? this.fire("swipe_nodirection", this.data)
            : this.options.snap && (this.animator.stop(), (this.animator = rt(this._el.move, { top: this.data.pos.start.y, left: this.data.pos.start.x, duration: this.options.duration, easing: U.easeOutStrong })));
      }
      _animateMomentum() {
        var t = { x: this.data.new_pos.x, y: this.data.new_pos.y },
          e = { duration: this.options.duration, easing: U.easeOutStrong };
        this.options.enable.y &&
          ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? (t.y = this.options.constraint.bottom) : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)),
          (e.top = Math.floor(t.y) + "px")),
          this.options.enable.x &&
    ...
    class Ct {
      constructor(t, e, i, o) {
        (this._el = { container: {}, background: {}, slider_container_mask: {}, slider_container: {}, slider_item_container: {} }),
          ...
          "object" == typeof t ? ((this._el.container = t), (this.options.id = S(6, "vco"))) : ((this.options.id = t), (this._el.container = I.get(t))),
      ...
      goTo(t, e, i) {
        ...
        t < this._slides.length &&
          ...
          e
            ...
            : (this.animator = rt(this._el.slider_container, { left: -this.slide_spacing * t + "px", duration: this.options.duration, easing: this.options.ease, complete: this._onSlideChange(i) })),
          this._slides[this.current_slide].setActive(!0),
          this._slides[this.current_slide + 1] ? (this.showNav(this._nav.next, !0), this._nav.next.update(this.getNavInfo(this._slides[this.current_slide + 1]))) : this.showNav(this._nav.next, !1),
          this._slides[this.current_slide - 1] ? (this.showNav(this._nav.previous, !0), this._nav.previous.update(this.getNavInfo(this._slides[this.current_slide - 1]))) : this.showNav(this._nav.previous, !1),
          (this.preloadTimer = setTimeout(function () {
            o.preloadSlides();
          }, this.options.duration)));
      }
      preloadSlides() {
        this._slides[this.current_slide + 1] && (this._slides[this.current_slide + 1].loadMedia(), this._slides[this.current_slide + 1].scrollToTop()),
          this._slides[this.current_slide + 2] && (this._slides[this.current_slide + 2].loadMedia(), this._slides[this.current_slide + 2].scrollToTop()),
          this._slides[this.current_slide - 1] && (this._slides[this.current_slide - 1].loadMedia(), this._slides[this.current_slide - 1].scrollToTop()),
          this._slides[this.current_slide - 2] && (this._slides[this.current_slide - 2].loadMedia(), this._slides[this.current_slide - 2].scrollToTop());
      }
      getNavInfo(t) {
        var e = { title: "", description: "" };
      ...
      changeBackground(t) {
        ...
        (n = t.color_value
          ...
          : this.options.default_bg_color),
          this.animator_background && this.animator_background.stop(),
          (e = n.r + "," + n.g + "," + n.b),
          (this.current_bg_color && this.current_bg_color == e) || ((this.current_bg_color = e), (o = !0)),
          o &&
            ("landscape" == this.options.layout
              ? (this._nav.next.setColor(!1),
                this._nav.previous.setColor(!1),
                n.r < 255 && n.g < 255 && n.b < 255 && (s = "15%"),
                t.image && (s = "0%"),
                (a += "opacity:0;"),
                (a += "background-image: -webkit-linear-gradient(left, color-stop(rgba(" + e + ",0.0001 ) " + s + "), color-stop(rgba(" + e + "," + "0.87) 15%));"),
                (a += "background-image: linear-gradient(to right, rgba(" + e + ",0.0001 ) " + s + ", rgba(" + e + "," + "0.87) 15%);"),
                (a += "background-repeat: repeat-x;"),
                (a += "filter: e(%('progid:DXImageTransform.Microsoft.gradient(startColorstr='%d', endColorstr='%d', GradientType=1)',argb(" + e + ", 0.0001),argb(" + e + ",0.80)));"))
              : (t.color_value ? (a += "background-color:" + t.color_value + ";") : (a += "background-color:#FFF;"),
                (n.r < 255 && n.g < 255 && n.b < 255) || t.image ? (this._nav.next.setColor(!0), this._nav.previous.setColor(!0)) : (this._nav.next.setColor(!1), this._nav.previous.setColor(!1))),
      ...
      fadeInBackground(t) {
        this.animator_background && this.animator_background.stop(),
          ...
          (this.animator_background = rt(this._el.background, { opacity: 1, duration: this.options.duration / 2, easing: this.options.ease }));
      }
      _updateDisplay(t, e, i, o) {
        var n, s;
        (s = void 0 === o ? this.options.layout : o),
          ...
          this._nav.next.setPosition({ top: n }),
          this._nav.previous.setPosition({ top: n });
        for (var a = 0; a < this._slides.length; a++) this._slides[a].updateDisplay(this.options.width, this.options.height, s), this._slides[a].setPosition({ left: this.slide_spacing * a, top: 0 });
      ...
      _introInterface() {
        ...
        this.options.width <= this.options.skinny_size ||
          (this._nav.next.updatePosition({ right: "130" }, !1, 3 * this.options.duration, this.options.ease, -100, !0), this._nav.previous.updatePosition({ left: "-100" }, !0, 3 * this.options.duration, this.options.ease, -200, !0));
      }
      _initLayout() {
        (this._el.container.className += " vco-storyslider"),
          (this._el.slider_container_mask = I.create("div", "vco-slider-container-mask", this._el.container)),
          (this._el.background = I.create("div", "vco-slider-background", this._el.container)),
          (this._el.slider_container = I.create("div", "vco-slider-container vcoanimate", this._el.slider_container_mask)),
          (this._el.slider_item_container = I.create("div", "vco-slider-item-container", this._el.slider_container)),
          (this.options.width = this._el.container.offsetWidth),
          (this.options.height = this._el.container.offsetHeight),
          (this._nav.previous = new lt({ title: "Previous", description: "description" }, { direction: "previous" })),
          (this._nav.next = new lt({ title: "Next", description: "description" }, { direction: "next" })),
          this._nav.next.addTo(this._el.container),
          this._nav.previous.addTo(this._el.container),
          (this._el.slider_container.style.left = "0px"),
          x &&
            ((this._swipable = new St(this._el.slider_container_mask, this._el.slider_container, { enable: { x: !0, y: !1 }, snap: !0 })),
            this._swipable.enable(),
            (this._message = new ct({}, { message_class: "vco-message-full", message_icon_class: "vco-icon-swipe-left" })),
            this._message.updateMessage(R.buttons.swipe_to_navigate),
      ...
      _onSlideChange(t) {
        t || this.fire("change", { current_slide: this.current_slide, uniqueid: this._slides[this.current_slide].data.uniqueid });
      }
      _onMouseClick(t) {}
      _fireMouseEvent(t) {
        if (this._loaded) {
          var e = t.type;
          (e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e), this.hasEventListeners(e) && ("contextmenu" === e && st.preventDefault(t), this.fire(e, { latlng: "something", layerPoint: "something else" }));
        }
      }
      _onLoaded() {
        this.fire("loaded", this.data), this.fire("title", { title: this._slides[0].title });
      }
    }
    P(Ct, W);
    class Et {
      constructor(t, e, i, o) {
        for (let t in o) {
          ...
          else for (var s in n) "function" == typeof n[s] ? this.on(t, n[s]) : console.log("WARNING: Ignoring invalid callback '" + n[s] + "' defined for listener '" + t + "' in StoryMap constructor");
        }
        return (
          (this.version = "0.1.16"),
          (this.ready = !1),
          ...
          (this.map = {}),
          (this._menubar = {}),
          (this._loaded = { storyslider: !1, map: !1 }),
          (this.data = {}),
          (this.options = {
      ...
      _initData(t) {
        ...
        "string" == typeof t
          ...
          : "object" == typeof t
          ? (t.storymap ? (e.data = t.storymap) : console.log("data must have a storymap property"), e._initOptions())
          : (console.log("data has unknown type"), e._initOptions());
      }
      _initOptions() {
        var t = this;
        !(function (t, e) {
          ...
          "landscape" == this.options.layout && (this.options.map_center_offset = { left: -200, top: 0 }),
          ...
          this.options.relative_date
            ? "undefined" != typeof moment
              ? t._loadLanguage()
              : z(this.options.script_path + "/library/moment.js", function () {
                  t._loadLanguage();
                })
            : t._loadLanguage(),
          y &&
            B(
              (function (t, e) {
                ...
                return n.join("/");
              })(this.options.script_path, "../css/fonts/font.emoji.css"),
              function () {}
            );
      }
      _loadLanguage() {
      ...
      _initLayout() {
        (this._el.container.className += " vco-storymap"),
          ...
          (this._el.menubar = I.create("div", "vco-menubar", this._el.container)),
          (this._el.map = I.create("div", "vco-map", this._el.container)),
          (this._el.storyslider = I.create("div", "vco-storyslider", this._el.container)),
          (this.options.width = this._el.container.offsetWidth),
          (this.options.height = this._el.container.offsetHeight),
      ...
      _updateDisplay(t, e, i) {
        ...
        i && (o = i),
          ...
          x && ((this.options.layout = M()), (n += " vco-mobile")),
          "portrait" == this.options.layout
            ? ((n += " vco-skinny"),
              ...
              e
                ? (this.animator_map && this.animator_map.stop(),
                  ...
                  (this.animator_storyslider = rt(this._el.storyslider, { height: this.options.storyslider_height + "px", duration: o, easing: U.easeOutStrong })))
                : ((this._el.map.style.height = Math.ceil(this.options.map_height) + "px"), (this._el.storyslider.style.height = this.options.storyslider_height + "px")),
      ...
      _onSlideChange(t) {
        this.current_slide != t.current_slide && ((this.current_slide = t.current_slide), this._map.goTo(this.current_slide), this.fire("change", { current_slide: this.current_slide }, this));
      }
      _onMapChange(t) {
      ...
      _fireMouseEvent(t) {
        if (this._loaded) {
          var e = t.type;
          (e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e), this.hasEventListeners(e) && ("contextmenu" === e && DomEvent.preventDefault(t), this.fire(e, { latlng: "something", layerPoint: "something else" }));
        }
      }
      _onMapLoaded() {

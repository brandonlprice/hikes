	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "This hike is located in Orange County's oldest park, Irvine Regional Park (est. 1897). The first half is on the Horseshoe Loop Trail and then Puma Ridge Trail is taken going back. It has nice bird's eye views of the park and the Santa Ana Mountains along Puma Ridge. "
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Pass through the gated entrance to park. Park in this lot after entering. It's pretty close to the entrance."
			}
			},
			{
			"date": "",

	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "Turn left on the Horseshoe Loop Trail which is the first possible left turn. There will be a sign. It is a multi-use trail also used for biking and horseback riding that loops around the entire park, a portion of it will be taken."
			}
			},
			{
			"date": "",

	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "Make the next first left to stay on the Horseshoe Loop Trail. Going straight takes you to the other trail taken later on."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Nearing the end of the descend at this point, the trail is narrow the whole way up. It may be less dense than depicted if trail maintenance was done."
			}
			},
			{
			"date": "",

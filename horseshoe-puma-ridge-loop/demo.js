	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "First pay at the gated entrance. Park in the lot pictured after entering. It's close to the entrance."
			}
			},
			{
			"date": "",
			...
			"text": {
				...
				"text": "Turn left onto the Horseshoe Loop Trail which is the first possible left turn. There will be a sign. It is a multi-use trail also used for biking and horseback riding that loops around the entire park, only a portion is taken in this hike."
			}
			},
			{
			"date": "",

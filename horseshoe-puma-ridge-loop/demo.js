	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "Turn left onto the Horseshoe Loop Trail. It is the first possible left turn and it has a sign. It is a multi-use trail also used for biking and horseback riding which loops around the entire park. Only a portion of it is taken in this hike."
			}
			},
			{
			"date": "",

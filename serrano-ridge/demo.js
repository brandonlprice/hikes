	...
	"storymap": {
		...
		"slides": [
			...
			"text": {
				...
				"text": "This hike is comprised of 4 different trails that loop around the northside of Laguna Coast Wildneress Park. The park spans 7,000 acres making it the largest of the Coastal Orange County nature reserve. There is about 875' of total elevation gain with mostly exposed and unshaded trails."
			}
			},
			{
			"date": "",
